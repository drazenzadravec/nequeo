...
{
    /// <summary>
    /// Schema data context code generator.
    /// </summary>
    public class CodeDomSchemaDataContext
    {
        ...
        private SchemaDataContextObjectContainer _data = null;
        ...
        public CodeCompileUnit GenerateCode(SchemaDataContextObjectContainer data)
        {
        ...
        /// <returns></returns>
        private SchemaDataContextObjectContainer ConvertToUpperCase(SchemaDataContextObjectContainer data)
        {
            SchemaDataContextObjectContainer items = data;
        ...
        private void InitialiseNamespace()
        {
            ...
            samples = new CodeNamespace(_companyName + ".DataAccess." + _dataBase + ".DataSet" +
            ...
            samples.Imports.Add(new CodeNamespaceImport("DataSet = " + _companyName + ".DataAccess." + _dataBase + ".DataSet"));
        }
        ...
        private void AddClasses()
        {
            ...
            _targetClass.Comments.Add(new CodeCommentStatement("The data access context schema object class.", true));
            _targetClass.Comments.Add(new CodeCommentStatement("</summary>", true));
        ...
        private void AddProperties()
        {
            ...
            foreach (var table in _tables)
            {
                if (_data.TableList.Contains(table.TableName.ToUpper(), new ToUpperComparer()) == !_tableListExclusion)
                {
                    ...
                    tableProperty.Comments.Add(new CodeCommentStatement("Gets, the " + table.TableName.ToLower() + " schema property for the object.", true));
                    tableProperty.Comments.Add(new CodeCommentStatement("</summary>", true));

                    // Assign the return type.
                    tableProperty.Type = new CodeTypeReference((!String.IsNullOrEmpty(_extendedName) ? "DataSet." + _extendedName + "." : "DataSet.") + "Schema." + table.TableName);
                    ...
                    //            new CodeSnippetExpression("return new " + (!String.IsNullOrEmpty(_extendedName) ? "DataSet." + _extendedName + "." : "DataSet.") + "Schema." + table.TableName + "()")) },
                    //    new CodeStatement[] { 
                    //        new CodeExpressionStatement(
                    //            new CodeSnippetExpression("return new " + (!String.IsNullOrEmpty(_extendedName) ? "DataSet." + _extendedName + "." : "DataSet.") + "Schema." + table.TableName + "(_specificPath)")) });
            ...
            if (GetDatabaseViews())
            {
                ...
                foreach (var view in _views)
                {
                    if (_data.TableList.Contains(view.TableName.ToUpper(), new ToUpperComparer()) == !_tableListExclusion)
                    {
                        ...
                        // Add the comments to the property.
                        tableProperty.Comments.Add(new CodeCommentStatement("<summary>", true));
                        tableProperty.Comments.Add(new CodeCommentStatement("Gets, the " + view.TableName.ToLower() + " schema property for the object.", true));
                        tableProperty.Comments.Add(new CodeCommentStatement("</summary>", true));

                        // Assign the return type.
                        tableProperty.Type = new CodeTypeReference((!String.IsNullOrEmpty(_extendedName) ? "DataSet." + _extendedName + "." : "DataSet.") + "Schema." + view.TableName);
                        ...
                        //    new CodeStatement[] { 
                        //    new CodeExpressionStatement(
                        //        new CodeSnippetExpression("return new " + (!String.IsNullOrEmpty(_extendedName) ? "DataSet." + _extendedName + "." : "DataSet.") + "Schema." + view.TableName + "()")) },
                        //    new CodeStatement[] { 
                        //    new CodeExpressionStatement(
                        //        new CodeSnippetExpression("return new " + (!String.IsNullOrEmpty(_extendedName) ? "DataSet." + _extendedName + "." : "DataSet.") + "Schema." + view.TableName + "(_specificPath)")) });
        ...
        {
            // Create a new namespace.
            samplesExtended = new CodeNamespace(_companyName + ".DataAccess." + _dataBase + ".DataSet" +
            ...
            samplesExtended.Imports.Add(new CodeNamespaceImport("DataSet = " + _companyName + ".DataAccess." + _dataBase + ".DataSet"));
        }
        ...
        private void AddPropertiesExtended()
        {
            ...
            tableProperty.Type = new CodeTypeReference(
                (!String.IsNullOrEmpty(_extendedName) ? "DataSet." + _extendedName + "." : "DataSet.") + "Extension." + _contextName);
