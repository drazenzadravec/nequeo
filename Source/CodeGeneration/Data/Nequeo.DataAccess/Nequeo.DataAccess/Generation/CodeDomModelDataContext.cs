...
namespace Nequeo.CustomTool.CodeGenerator.Generation
{
    ...
    /// </summary>
    public class CodeDomModelDataContext
    {
        ...
        private ModelDataContextObjectContainer _data = null;
        ...
        public CodeCompileUnit GenerateCode(ModelDataContextObjectContainer data)
        {
        ...
        /// <returns></returns>
        private ModelDataContextObjectContainer ConvertToUpperCase(ModelDataContextObjectContainer data)
        {
            ModelDataContextObjectContainer items = data;
        ...
        private void InitialiseNamespace()
        {
            ...
            samples = new CodeNamespace(_companyName + ".DataAccess." + _dataBase + ".Edm" +
            ...
            samples.Imports.Add(new CodeNamespaceImport("Edm = " + _companyName + ".DataAccess." + _dataBase + ".Edm"));
        }
        ...
        private void AddClasses()
        {
            ...
            _targetClass.Comments.Add(new CodeCommentStatement("The data access context model object class.", true));
            _targetClass.Comments.Add(new CodeCommentStatement("</summary>", true));
        ...
        private void AddProperties()
        {
            ...
            foreach (var table in _tables)
            {
                if (_data.TableList.Contains(table.TableName.ToUpper(), new ToUpperComparer()) == !_tableListExclusion)
                {
                    ...
                    tableProperty.Comments.Add(new CodeCommentStatement("Gets, the " + table.TableName.ToLower() + " model property for the object.", true));
                    tableProperty.Comments.Add(new CodeCommentStatement("</summary>", true));

                    // Assign the return type.
                    tableProperty.Type = new CodeTypeReference((!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + "Model." + table.TableName);
                    ...
                    //                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + "Model." + table.TableName + "()")) },
                    //    new CodeStatement[] { 
                    //        new CodeExpressionStatement(
                    //            new CodeSnippetExpression("return new " + 
                    //                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + "Model." + table.TableName + "(_specificPath)")) });
            ...
            if (GetDatabaseViews())
            {
                ...
                foreach (var view in _views)
                {
                    if (_data.TableList.Contains(view.TableName.ToUpper(), new ToUpperComparer()) == !_tableListExclusion)
                    {
                        ...
                        // Add the comments to the property.
                        tableProperty.Comments.Add(new CodeCommentStatement("<summary>", true));
                        tableProperty.Comments.Add(new CodeCommentStatement("Gets, the " + view.TableName.ToLower() + " model property for the object.", true));
                        tableProperty.Comments.Add(new CodeCommentStatement("</summary>", true));

                        // Assign the return type.
                        tableProperty.Type = new CodeTypeReference((!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + "Model." + view.TableName);
                        ...
                        //    new CodeExpressionStatement(
                        //        new CodeSnippetExpression("return new " + 
                        //            (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + "Model." + view.TableName + "()")) },
                        //    new CodeStatement[] { 
                        //    new CodeExpressionStatement(
                        //        new CodeSnippetExpression("return new " + 
                        //            (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + "Model." + view.TableName + "(_specificPath)")) });
        ...
        {
            // Create a new namespace.
            samplesExtended = new CodeNamespace(_companyName + ".DataAccess." + _dataBase + ".Edm" +
        ...
        /// Add the constrctor to the class.
        /// </summary>
        private void AddConstructorsExtended()
        {
            CodeConstructor constructor1 = new CodeConstructor();
            constructor1.Attributes = MemberAttributes.Public | MemberAttributes.Final;
            constructor1.Parameters.Add(new CodeParameterDeclarationExpression(typeof(string), "connectionStringName"));
            constructor1.BaseConstructorArgs.Add(new CodeSnippetExpression("connectionStringName"));

            // Create the comments on the constructor.
            constructor1.Comments.Add(new CodeCommentStatement("<summary>", true));
            constructor1.Comments.Add(new CodeCommentStatement("The data access context object class.", true));
            constructor1.Comments.Add(new CodeCommentStatement("</summary>", true));
            constructor1.Comments.Add(new CodeCommentStatement("<param name=\"connectionStringName\">Either the database name or a connection string.</param>", true));

            // Add the constructor to the class.
            _targetContextClass.Members.Add(constructor1);
        }
        ...
        private void AddPropertiesExtended()
        {
            ...
            tableProperty.Type = new CodeTypeReference(
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + "Extension." + _contextName);
