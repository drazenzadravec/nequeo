...
namespace Nequeo.CustomTool.CodeGenerator.Generation
{
    ...
    /// </summary>
    public class CodeDomModelObject
    {
        ...
        private string _edmDataContextName = "EdmDataContext";
        ...
        /// <param name="edmDataContextName">The edm data context name</param>
        ...
        public CodeCompileUnit GenerateCode(string tableName,
            string edmDataContextName, string dataBase, string companyName,
            string configKeyDatabaseConnection, bool useAnonymousDataEntity,
            int connectionType, string extendedName, int connectionDataType, string dataAccessProvider)
        {
            ...
            _edmDataContextName = edmDataContextName;
            ...
            if (!useAnonymousDataEntity)
            {
                ...
                _inheritanceCodeTypeReference = "EdmGenericBase<" +
                    (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName + ", " +
                    (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _className + ">";
            }
            else
            {
                _dataEntityClassName = "Nequeo.Data.Access.Control.AnonymousType";
                _inheritanceCodeTypeReference = "EdmAnonymousGenericBase<" +
                    (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName + ", " +
                    (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _className + ">";
            }
        ...
        private void InitialiseNamespace()
        {
            ...
            samples = new CodeNamespace(_companyName + ".DataAccess." + _dataBaseName + ".Edm" +
                (!String.IsNullOrEmpty(_extendedName) ? "." + _extendedName : "") + ".Model");
            ...
            samples.Imports.Add(new CodeNamespaceImport("Edm = " + _companyName + ".DataAccess." + _dataBaseName + ".Edm"));
        ...
        private void AddClasses()
        {
            ...
            CodeRegionDirective startRegion = new CodeRegionDirective(CodeRegionMode.Start, _className + " Edm Extension Type");
            ...
            _targetClass.Comments.Add(new CodeCommentStatement("The " + _className.ToLower() + " model object class.", true));
            _targetClass.Comments.Add(new CodeCommentStatement("</summary>", true));
        ...
        private void AddConstructors()
        {
            ...
            constructor1.BaseConstructorArgs.Add(new CodeSnippetExpression("modelItem"));
            ...
            constructor2.BaseConstructorArgs.Add(new CodeSnippetExpression("modelItem"));
        ...
        private void AddConstants()
        {
            ...
            connectionDefaultConstant.InitExpression = new CodeSnippetExpression("\"name=" + _configKeyDatabaseConnection + "\"");
        ...
        private void AddFieldMore()
        {
            ...
            selectField.Type = new CodeTypeReference("ISelectEdmGenericBase<" +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName + ", " +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _className + ">");
            ...
            deleteField.Type = new CodeTypeReference("IDeleteEdmGenericBase<" +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName + ", " +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _className + ">");
            ...
            insertField.Type = new CodeTypeReference("IInsertEdmGenericBase<" +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName + ", " +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _className + ">");
            ...
            updateField.Type = new CodeTypeReference("IUpdateEdmGenericBase<" +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName + ", " +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _className + ">");
            ...
            linqDataField.Type = new CodeTypeReference("IEdmDataGenericBase<" +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName + ", " +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _className + ">");
            ...
            contextField.Type = new CodeTypeReference((!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName);
        ...
        private void AddProperties()
        {
            ...
            tableProperty.Type = new CodeTypeReference((!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName);

            // Add the code to the
            // get section of the property.
            tableProperty.GetStatements.Add(new CodeExpressionStatement(
                new CodeSnippetExpression("this.Context = new " + (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName + 
                    "(defaultDatabaseConnectionConfigurationKey)")));
            tableProperty.GetStatements.Add(new CodeExpressionStatement(
                new CodeSnippetExpression("this.Context.Configuration.LazyLoadingEnabled = this._referenceLazyLoading;")));
        ...
        private void AddPropertiesMore()
        {
            ...
            // Assign the return type.
            selectProperty.Type = new CodeTypeReference("ISelectEdmGenericBase<" +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName + ", " +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _className + ">");
            ...
            selectProperty.GetStatements.Add(new CodeExpressionStatement(
                new CodeSnippetExpression("this.SelectContext.DataContext = new " + 
                    (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + 
                    _edmDataContextName + "(defaultDatabaseConnectionConfigurationKey)")));
            selectProperty.GetStatements.Add(new CodeExpressionStatement(
                new CodeSnippetExpression("this.SelectContext.DataContext.Configuration.LazyLoadingEnabled = this._referenceLazyLoading;")));
            ...
            // Assign the return type.
            deletetProperty.Type = new CodeTypeReference("IDeleteEdmGenericBase<" +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName + ", " +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _className + ">");
            ...
            deletetProperty.GetStatements.Add(new CodeExpressionStatement(
                new CodeSnippetExpression("this.DeleteContext.DataContext = new " + 
                    (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + 
                    _edmDataContextName + "(defaultDatabaseConnectionConfigurationKey)")));
            deletetProperty.GetStatements.Add(new CodeExpressionStatement(
                new CodeSnippetExpression("this.DeleteContext.DataContext.Configuration.LazyLoadingEnabled = this._referenceLazyLoading;")));
            ...
            // Assign the return type.
            inserttProperty.Type = new CodeTypeReference("IInsertEdmGenericBase<" +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName + ", " +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _className + ">");
            ...
            inserttProperty.GetStatements.Add(new CodeExpressionStatement(
                new CodeSnippetExpression("this.InsertContext.DataContext = new " + 
                    (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + 
                    _edmDataContextName + "(defaultDatabaseConnectionConfigurationKey)")));
            inserttProperty.GetStatements.Add(new CodeExpressionStatement(
                new CodeSnippetExpression("this.InsertContext.DataContext.Configuration.LazyLoadingEnabled = this._referenceLazyLoading;")));
            ...
            // Assign the return type.
            updateProperty.Type = new CodeTypeReference("IUpdateEdmGenericBase<" +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName + ", " +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _className + ">");
            ...
            updateProperty.GetStatements.Add(new CodeExpressionStatement(
                new CodeSnippetExpression("this.UpdateContext.DataContext = new " + 
                    (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + 
                    _edmDataContextName + "(defaultDatabaseConnectionConfigurationKey)")));
            updateProperty.GetStatements.Add(new CodeExpressionStatement(
                new CodeSnippetExpression("this.UpdateContext.DataContext.Configuration.LazyLoadingEnabled = this._referenceLazyLoading;")));
            ...
            // Assign the return type.
            setDataField.Type = new CodeTypeReference("IEdmDataGenericBase<" +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName + ", " +
                (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _className + ">");
            ...
            setDataField.GetStatements.Add(new CodeExpressionStatement(
                new CodeSnippetExpression("this.CommonContext.DataContext = new " + 
                    (!String.IsNullOrEmpty(_extendedName) ? "Edm." + _extendedName + "." : "Edm.") + _edmDataContextName + 
                    "(defaultDatabaseConnectionConfigurationKey)")));
            setDataField.GetStatements.Add(new CodeExpressionStatement(
                new CodeSnippetExpression("this.CommonContext.DataContext.Configuration.LazyLoadingEnabled = this._referenceLazyLoading;")));
