...
{
    /// <summary>
    /// The secure file transfer client socket.
    /// </summary>
    public class SslClient
    {
        ...
        public SslClient(NetworkCredential credentials,
        ...
        private X509Certificate2Info sslCertificate = null;
            ...
            X509Chain chain, SslPolicyErrors sslPolicyErrors)
        {
            ...
            if (connection.ValidateCertificate)
            {
                ...
                else
                {
                    ...
                    sslCertificate = new X509Certificate2Info(certificate as X509Certificate2,
        ...
        private void Connect()
        {
            ...
            // from the socket.
            sslStream = new SslStream(client.GetStream(), true, callback);
            ...
            sslStream.BeginRead(readBuffer, 0, READ_BUFFER_SIZE,
        ...
        private long DownloadFileEx(FileStream fileStream, SslStream nStream, long numberBytesRead)
        {
                ...
                (totalBytesRead + numberBytesRead < filePath.DestinationFileSize))
            {
                ...
                while (totalBytesRead + numberBytesRead < filePath.DestinationFileSize);
