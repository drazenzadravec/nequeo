...
//
//*****************************************************************************
NequeoSecurity::PromptForCredential::PromptForCredential() :
...
//
//*****************************************************************************
String^ NequeoSecurity::PromptForCredential::TargetName::get()
{
    CheckNotDisposed();
    return m_targetName;
}
void NequeoSecurity::PromptForCredential::TargetName::set(String^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
int NequeoSecurity::PromptForCredential::ErrorCode::get()
{
    CheckNotDisposed();
    return m_errorCode;
}
void NequeoSecurity::PromptForCredential::ErrorCode::set(int value)
{
    CheckNotDisposed();
    m_errorCode = value;
}
...
//
//*****************************************************************************
String^ NequeoSecurity::PromptForCredential::UserName::get()
{
    CheckNotDisposed();
    return m_userName;
}
void NequeoSecurity::PromptForCredential::UserName::set(String^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
Security::SecureString^ NequeoSecurity::PromptForCredential::Password::get()
{
    CheckNotDisposed();
...
void NequeoSecurity::PromptForCredential::Password::set(Security::SecureString^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::PromptForCredential::SaveChecked::get()
{
    CheckNotDisposed();
    return m_saveChecked;
}
void NequeoSecurity::PromptForCredential::SaveChecked::set(bool value)
{
    CheckNotDisposed();
    m_saveChecked = value;
}
...
//
//*****************************************************************************
String^ NequeoSecurity::PromptForCredential::Message::get()
{
    CheckNotDisposed();
    return m_message ? m_message : String::Empty;
}
void NequeoSecurity::PromptForCredential::Message::set(String^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
String^ NequeoSecurity::PromptForCredential::Title::get()
{
    CheckNotDisposed();
    return m_title ? m_title : String::Empty;
}
void NequeoSecurity::PromptForCredential::Title::set(String^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
Drawing::Bitmap^ NequeoSecurity::PromptForCredential::Banner::get()
{
    CheckNotDisposed();
    return m_banner;
}
void NequeoSecurity::PromptForCredential::Banner::set(Drawing::Bitmap^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::PromptForCredential::AlwaysShowUI::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_ALWAYS_SHOW_UI & m_flags);
}
void NequeoSecurity::PromptForCredential::AlwaysShowUI::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::PromptForCredential::CompleteUserName::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_COMPLETE_USERNAME & m_flags);
}
void NequeoSecurity::PromptForCredential::CompleteUserName::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::PromptForCredential::DoNotPersist::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_DO_NOT_PERSIST & m_flags);
}
void NequeoSecurity::PromptForCredential::DoNotPersist::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::PromptForCredential::ExcludeCertificates::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_EXCLUDE_CERTIFICATES & m_flags);
}
void NequeoSecurity::PromptForCredential::ExcludeCertificates::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::PromptForCredential::ExpectConfirmation::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_EXPECT_CONFIRMATION & m_flags);
}
void NequeoSecurity::PromptForCredential::ExpectConfirmation::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::PromptForCredential::GenericCredentials::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_GENERIC_CREDENTIALS & m_flags);
}
void NequeoSecurity::PromptForCredential::GenericCredentials::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::PromptForCredential::IncorrectPassword::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_INCORRECT_PASSWORD & m_flags);
}
void NequeoSecurity::PromptForCredential::IncorrectPassword::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::PromptForCredential::Persist::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_PERSIST & m_flags);
}
void NequeoSecurity::PromptForCredential::Persist::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::PromptForCredential::RequestAdministrator::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_REQUEST_ADMINISTRATOR & m_flags);
}
void NequeoSecurity::PromptForCredential::RequestAdministrator::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::PromptForCredential::RequireCertificate::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_REQUIRE_CERTIFICATE & m_flags);
}
void NequeoSecurity::PromptForCredential::RequireCertificate::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::PromptForCredential::RequireSmartCard::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_REQUIRE_SMARTCARD & m_flags);
}
void NequeoSecurity::PromptForCredential::RequireSmartCard::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::PromptForCredential::ShowSaveCheckBox::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_SHOW_SAVE_CHECK_BOX & m_flags);
}
void NequeoSecurity::PromptForCredential::ShowSaveCheckBox::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::PromptForCredential::UserNameReadOnly::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_KEEP_USERNAME & m_flags);
}
void NequeoSecurity::PromptForCredential::UserNameReadOnly::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::PromptForCredential::ValidateUserName::get()
{
    CheckNotDisposed();
    return 0 != (CREDUI_FLAGS_VALIDATE_USERNAME & m_flags);
}
void NequeoSecurity::PromptForCredential::ValidateUserName::set(bool value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
void NequeoSecurity::PromptForCredential::ConfirmCredentials()
{
    CheckNotDisposed();
    pin_ptr<const wchar_t> pinnedTargetName = PtrToStringChars(m_targetName);
...
//
//*****************************************************************************
void NequeoSecurity::PromptForCredential::Flag(bool add,
                                     DWORD flag)
{
    if (add)
    {
...
//
//*****************************************************************************
void NequeoSecurity::PromptForCredential::CheckNotDisposed()
{
    if (m_disposed)
    {
