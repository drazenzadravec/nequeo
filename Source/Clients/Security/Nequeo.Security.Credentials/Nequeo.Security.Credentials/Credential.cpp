...
//
//*****************************************************************************
NequeoSecurity::Credential::Credential(Credential^ copy) :
    m_disposed(true)
{
    if (nullptr == copy)
    {
...
//
//*****************************************************************************
NequeoSecurity::Credential::Credential(String^ targetName,
                             CredentialType type) :
    m_disposed(true)
{
...
//
//*****************************************************************************
NequeoSecurity::Credential::~Credential()
{
    if (!m_disposed)
    {
        delete m_password;
...
//
//*****************************************************************************
String^ NequeoSecurity::Credential::TargetName::get()
{
    CheckNotDisposed();
    return m_targetName;
}
...
//
//*****************************************************************************
NequeoSecurity::CredentialType NequeoSecurity::Credential::Type::get()
{
    CheckNotDisposed();
    return m_type;
}
...
//
//*****************************************************************************
String^ NequeoSecurity::Credential::UserName::get()
{
    CheckNotDisposed();
    return m_userName;
}
void NequeoSecurity::Credential::UserName::set(String^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
Security::SecureString^ NequeoSecurity::Credential::Password::get()
{
    CheckNotDisposed();
    return m_password;
}
void NequeoSecurity::Credential::Password::set(Security::SecureString^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
NequeoSecurity::CredentialPersistence NequeoSecurity::Credential::Persistence::get()
{
    CheckNotDisposed();
    return m_persistence;
}
void NequeoSecurity::Credential::Persistence::set(CredentialPersistence value)
{
    CheckNotDisposed();
    m_persistence = value;
}
...
//
//*****************************************************************************
String^ NequeoSecurity::Credential::Description::get()
{
    CheckNotDisposed();
    return m_description;
}
void NequeoSecurity::Credential::Description::set(String^ value)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
DateTime NequeoSecurity::Credential::LastWriteTime::get()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
DateTime NequeoSecurity::Credential::LastWriteTimeUtc::get()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
int NequeoSecurity::Credential::SecrectLength::get()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
void NequeoSecurity::Credential::Load()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
void NequeoSecurity::Credential::Save()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
void NequeoSecurity::Credential::Delete()
{
    CheckNotDisposed();
...
//
//*****************************************************************************
void NequeoSecurity::Credential::ChangeTargetName(String^ newTargetName)
{
    CheckNotDisposed();
...
//
//*****************************************************************************
bool NequeoSecurity::Credential::Exists(String^ targetName,
                              CredentialType type)
{
    if (nullptr == targetName)
    {
...
//
//*****************************************************************************
void NequeoSecurity::Credential::Delete(String^ targetName,
                              CredentialType type)
{
    if (nullptr == targetName)
    {
...
//
//*****************************************************************************
NequeoSecurity::Credential::Credential(PCREDENTIAL credential)
{
...
//
//*****************************************************************************
void NequeoSecurity::Credential::Initialize(PCREDENTIAL credential)
{
...
//
//*****************************************************************************
void NequeoSecurity::Credential::Initialize(String^ targetName,
                                  CredentialType type,
                                  String^ userName,
                                  Security::SecureString^ password,
                                  int secretLength,
...
//
//*****************************************************************************
void NequeoSecurity::Credential::CheckNotDisposed()
{
    if (m_disposed)
    {
