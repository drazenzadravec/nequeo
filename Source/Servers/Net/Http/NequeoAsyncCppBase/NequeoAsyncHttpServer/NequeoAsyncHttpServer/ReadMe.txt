...
USAGE
=====
This sample includes Microsoft Visual Studio .NET project files. To create NequeoAsyncHttpServer.exe,
load NequeoAsyncHttpServer.sln and build the project.

To run the sample:
C:>NequeoAsyncHttpServer.exe <Url> <ServerDirectory>
...
Example:
C:>NequeoAsyncHttpServer.exe http://*:80/ C:\httpsrv
C:>NequeoAsyncHttpServer.exe http://localhost:8080/ D:\inetpub\repository
