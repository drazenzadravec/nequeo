...
namespace Nequeo.DataAccess.CloudInteraction.Data.Extension
{
    ...
    #region ContactType Data Extension Type
    /// <summary>
    /// The contacttype replica object class.
    /// </summary>
    public partial class ContactType : DataBase<Data.ContactType>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.ContactType> SelectContext;
        
        private IDeleteDataGenericBase<Data.ContactType> DeleteContext;
        
        private IInsertDataGenericBase<Data.ContactType> InsertContext;
        
        private IUpdateDataGenericBase<Data.ContactType> UpdateContext;
        
        private ICommonDataGenericBase<Data.ContactType> CommonContext;
        ...
        public ContactType(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.ContactType> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.ContactType> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.ContactType> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.ContactType> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.ContactType> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the contacttype entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.ContactType queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.ContactType> QueryableProvider()
        {
            return new ContactType().Select.QueryableProvider();
        }
    }
    #endregion
}
