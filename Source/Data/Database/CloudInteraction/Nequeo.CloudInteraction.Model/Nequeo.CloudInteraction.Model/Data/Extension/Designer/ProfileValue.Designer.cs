...
namespace Nequeo.DataAccess.CloudInteraction.Data.Extension
{
    ...
    #region ProfileValue Data Extension Type
    /// <summary>
    /// The profilevalue replica object class.
    /// </summary>
    public partial class ProfileValue : DataBase<Data.ProfileValue>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.ProfileValue> SelectContext;
        
        private IDeleteDataGenericBase<Data.ProfileValue> DeleteContext;
        
        private IInsertDataGenericBase<Data.ProfileValue> InsertContext;
        
        private IUpdateDataGenericBase<Data.ProfileValue> UpdateContext;
        
        private ICommonDataGenericBase<Data.ProfileValue> CommonContext;
        ...
        public ProfileValue(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.ProfileValue> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.ProfileValue> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.ProfileValue> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.ProfileValue> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.ProfileValue> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the profilevalue entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.ProfileValue queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.ProfileValue> QueryableProvider()
        {
            return new ProfileValue().Select.QueryableProvider();
        }
    }
    #endregion
}
