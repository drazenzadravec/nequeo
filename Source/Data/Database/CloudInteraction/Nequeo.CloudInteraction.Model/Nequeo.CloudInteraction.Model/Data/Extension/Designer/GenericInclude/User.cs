...
namespace Nequeo.DataAccess.CloudInteraction.Data.Extension
{
    ...
    #region User DataSet Extension Type
    /// <summary>
    /// The User schema object class.
    /// </summary>
    public partial class User
    {
		private Nequeo.Threading.AsyncExecutionHandler<User> _asyncAccount = null;
        private Exception _exception = null;
		private UserThread _threadUserContext = null;
		...
		/// <summary>
        /// Gets the User threading context.
        /// </summary>
        public UserThread UserThreadContext
        {
            get { return _threadUserContext; }
        }
        ...
        public virtual DataTransactions<Data.User> DelegateTransaction()
        {
           return new DataTransactions<Data.User>(
                    this.Insert, 
                    this.Delete, 
                    this.Update, 
                    this.Select);
		...
		/// <summary>
        /// User threading handler.
        /// </summary>
        public class UserThread : Nequeo.Threading.AsyncExecutionHandler<User>
        {
            /// <summary>
            /// User threading handler.
            /// </summary>
            /// <param name="service">The User type.</param>
            public UserThread(User service)
                : base(service) { }
        }
    }
    #endregion
