...
namespace Nequeo.DataAccess.CloudInteraction.Data.Extension
{
    ...
    #region OAuthToken Data Extension Type
    /// <summary>
    /// The oauthtoken replica object class.
    /// </summary>
    public partial class OAuthToken : DataBase<Data.OAuthToken>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.OAuthToken> SelectContext;
        
        private IDeleteDataGenericBase<Data.OAuthToken> DeleteContext;
        
        private IInsertDataGenericBase<Data.OAuthToken> InsertContext;
        
        private IUpdateDataGenericBase<Data.OAuthToken> UpdateContext;
        
        private ICommonDataGenericBase<Data.OAuthToken> CommonContext;
        ...
        public OAuthToken(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.OAuthToken> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.OAuthToken> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.OAuthToken> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.OAuthToken> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.OAuthToken> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the oauthtoken entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.OAuthToken queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.OAuthToken> QueryableProvider()
        {
            return new OAuthToken().Select.QueryableProvider();
        }
    }
    #endregion
}
