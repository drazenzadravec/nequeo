...
namespace Nequeo.DataAccess.CloudInteraction.Data.Extension
{
    ...
    #region Profile Data Extension Type
    /// <summary>
    /// The profile replica object class.
    /// </summary>
    public partial class Profile : DataBase<Data.Profile>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Profile> SelectContext;
        
        private IDeleteDataGenericBase<Data.Profile> DeleteContext;
        
        private IInsertDataGenericBase<Data.Profile> InsertContext;
        
        private IUpdateDataGenericBase<Data.Profile> UpdateContext;
        
        private ICommonDataGenericBase<Data.Profile> CommonContext;
        ...
        public Profile(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Profile> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Profile> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Profile> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Profile> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Profile> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the profile entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.Profile queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Profile> QueryableProvider()
        {
            return new Profile().Select.QueryableProvider();
        }
    }
    #endregion
}
