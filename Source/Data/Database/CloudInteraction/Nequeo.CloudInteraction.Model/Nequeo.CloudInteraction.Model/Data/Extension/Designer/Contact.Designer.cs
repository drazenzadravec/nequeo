...
namespace Nequeo.DataAccess.CloudInteraction.Data.Extension
{
    ...
    #region Contact Data Extension Type
    /// <summary>
    /// The contact replica object class.
    /// </summary>
    public partial class Contact : DataBase<Data.Contact>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Contact> SelectContext;
        
        private IDeleteDataGenericBase<Data.Contact> DeleteContext;
        
        private IInsertDataGenericBase<Data.Contact> InsertContext;
        
        private IUpdateDataGenericBase<Data.Contact> UpdateContext;
        
        private ICommonDataGenericBase<Data.Contact> CommonContext;
        ...
        public Contact(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Contact> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Contact> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Contact> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Contact> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Contact> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the contact entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.Contact queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Contact> QueryableProvider()
        {
            return new Contact().Select.QueryableProvider();
        }
    }
    #endregion
}
