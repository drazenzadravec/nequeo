...
namespace Nequeo.DataAccess.CloudInteraction.Data.Extension
{
    ...
    #region Role Data Extension Type
    /// <summary>
    /// The role replica object class.
    /// </summary>
    public partial class Role : DataBase<Data.Role>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Role> SelectContext;
        
        private IDeleteDataGenericBase<Data.Role> DeleteContext;
        
        private IInsertDataGenericBase<Data.Role> InsertContext;
        
        private IUpdateDataGenericBase<Data.Role> UpdateContext;
        
        private ICommonDataGenericBase<Data.Role> CommonContext;
        ...
        public Role(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Role> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Role> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Role> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Role> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Role> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the role entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.Role queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Role> QueryableProvider()
        {
            return new Role().Select.QueryableProvider();
        }
    }
    #endregion
}
