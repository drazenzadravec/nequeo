...
namespace Nequeo.DataAccess.CloudInteraction.Data.Extension
{
    ...
    #region Client Data Extension Type
    /// <summary>
    /// The client replica object class.
    /// </summary>
    public partial class Client : DataBase<Data.Client>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Client> SelectContext;
        
        private IDeleteDataGenericBase<Data.Client> DeleteContext;
        
        private IInsertDataGenericBase<Data.Client> InsertContext;
        
        private IUpdateDataGenericBase<Data.Client> UpdateContext;
        
        private ICommonDataGenericBase<Data.Client> CommonContext;
        ...
        public Client(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Client> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Client> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Client> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Client> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Client> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the client entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.Client queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Client> QueryableProvider()
        {
            return new Client().Select.QueryableProvider();
        }
    }
    #endregion
}
