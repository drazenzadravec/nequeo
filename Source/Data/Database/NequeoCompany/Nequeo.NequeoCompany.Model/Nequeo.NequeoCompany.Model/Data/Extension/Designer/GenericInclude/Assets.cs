...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region Assets DataSet Extension Type
    /// <summary>
    /// The Assets schema object class.
    /// </summary>
    public partial class Assets
    {
		private Nequeo.Threading.AsyncExecutionHandler<Assets> _asyncAccount = null;
        private Exception _exception = null;
		private AssetsThread _threadAssetsContext = null;
		...
		/// <summary>
        /// Gets the Assets threading context.
        /// </summary>
        public AssetsThread AssetsThreadContext
        {
            get { return _threadAssetsContext; }
        }

		/// <summary>
        /// On create instance of Assets
        /// </summary>
		partial void OnCreated()
		{
			// Start the async control.
            _asyncAccount = new Nequeo.Threading.AsyncExecutionHandler<Assets>();
			...
			_threadAssetsContext = new AssetsThread(this);
			_threadAssetsContext.AsyncError += new Threading.EventHandler<Exception>(_asyncAccount_AsyncError);
		}
        ...
        public virtual DataTransactions<Data.Assets> DelegateTransaction()
        {
           return new DataTransactions<Data.Assets>(
                    this.Insert, 
                    this.Delete, 
                    this.Update, 
                    this.Select);
		...
		/// <summary>
        /// Assets threading handler.
        /// </summary>
        public class AssetsThread : Nequeo.Threading.AsyncExecutionHandler<Assets>
        {
            /// <summary>
            /// Assets threading handler.
            /// </summary>
            /// <param name="service">The Assets type.</param>
            public AssetsThread(Assets service)
                : base(service) { }
        }
    }
    #endregion
