...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region EmployeeBankAccounts Data Extension Type
    /// <summary>
    /// The employeebankaccounts replica object class.
    /// </summary>
    public partial class EmployeeBankAccounts : DataBase<Data.EmployeeBankAccounts>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.EmployeeBankAccounts> SelectContext;
        
        private IDeleteDataGenericBase<Data.EmployeeBankAccounts> DeleteContext;
        
        private IInsertDataGenericBase<Data.EmployeeBankAccounts> InsertContext;
        
        private IUpdateDataGenericBase<Data.EmployeeBankAccounts> UpdateContext;
        
        private ICommonDataGenericBase<Data.EmployeeBankAccounts> CommonContext;
        ...
        public EmployeeBankAccounts(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.EmployeeBankAccounts> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.EmployeeBankAccounts> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.EmployeeBankAccounts> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.EmployeeBankAccounts> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.EmployeeBankAccounts> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the employeebankaccounts entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.EmployeeBankAccounts queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.EmployeeBankAccounts> QueryableProvider()
        {
            return new EmployeeBankAccounts().Select.QueryableProvider();
        }
    }
    #endregion
}
