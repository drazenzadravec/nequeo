...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region TransactionType Data Extension Type
    /// <summary>
    /// The transactiontype replica object class.
    /// </summary>
    public partial class TransactionType : DataBase<Data.TransactionType>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.TransactionType> SelectContext;
        
        private IDeleteDataGenericBase<Data.TransactionType> DeleteContext;
        
        private IInsertDataGenericBase<Data.TransactionType> InsertContext;
        
        private IUpdateDataGenericBase<Data.TransactionType> UpdateContext;
        
        private ICommonDataGenericBase<Data.TransactionType> CommonContext;
        ...
        public TransactionType(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.TransactionType> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.TransactionType> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.TransactionType> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.TransactionType> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.TransactionType> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the transactiontype entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.TransactionType queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.TransactionType> QueryableProvider()
        {
            return new TransactionType().Select.QueryableProvider();
        }
    }
    #endregion
}
