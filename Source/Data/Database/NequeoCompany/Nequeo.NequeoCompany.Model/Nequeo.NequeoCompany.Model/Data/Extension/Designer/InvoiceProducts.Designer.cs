...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region InvoiceProducts Data Extension Type
    /// <summary>
    /// The invoiceproducts replica object class.
    /// </summary>
    public partial class InvoiceProducts : DataBase<Data.InvoiceProducts>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.InvoiceProducts> SelectContext;
        
        private IDeleteDataGenericBase<Data.InvoiceProducts> DeleteContext;
        
        private IInsertDataGenericBase<Data.InvoiceProducts> InsertContext;
        
        private IUpdateDataGenericBase<Data.InvoiceProducts> UpdateContext;
        
        private ICommonDataGenericBase<Data.InvoiceProducts> CommonContext;
        ...
        public InvoiceProducts(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.InvoiceProducts> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.InvoiceProducts> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.InvoiceProducts> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.InvoiceProducts> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.InvoiceProducts> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the invoiceproducts entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.InvoiceProducts queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.InvoiceProducts> QueryableProvider()
        {
            return new InvoiceProducts().Select.QueryableProvider();
        }
    }
    #endregion
}
