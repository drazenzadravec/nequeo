...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region ProductCategory Data Extension Type
    /// <summary>
    /// The productcategory replica object class.
    /// </summary>
    public partial class ProductCategory : DataBase<Data.ProductCategory>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.ProductCategory> SelectContext;
        
        private IDeleteDataGenericBase<Data.ProductCategory> DeleteContext;
        
        private IInsertDataGenericBase<Data.ProductCategory> InsertContext;
        
        private IUpdateDataGenericBase<Data.ProductCategory> UpdateContext;
        
        private ICommonDataGenericBase<Data.ProductCategory> CommonContext;
        ...
        public ProductCategory(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.ProductCategory> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.ProductCategory> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.ProductCategory> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.ProductCategory> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.ProductCategory> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the productcategory entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.ProductCategory queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.ProductCategory> QueryableProvider()
        {
            return new ProductCategory().Select.QueryableProvider();
        }
    }
    #endregion
}
