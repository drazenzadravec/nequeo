...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region TaxReturn Data Extension Type
    /// <summary>
    /// The taxreturn replica object class.
    /// </summary>
    public partial class TaxReturn : DataBase<Data.TaxReturn>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.TaxReturn> SelectContext;
        
        private IDeleteDataGenericBase<Data.TaxReturn> DeleteContext;
        
        private IInsertDataGenericBase<Data.TaxReturn> InsertContext;
        
        private IUpdateDataGenericBase<Data.TaxReturn> UpdateContext;
        
        private ICommonDataGenericBase<Data.TaxReturn> CommonContext;
        ...
        public TaxReturn(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.TaxReturn> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.TaxReturn> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.TaxReturn> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.TaxReturn> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.TaxReturn> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the taxreturn entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.TaxReturn queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.TaxReturn> QueryableProvider()
        {
            return new TaxReturn().Select.QueryableProvider();
        }
    }
    #endregion
}
