...
{
    /// <summary>
    /// The GstType data member extension.
    /// </summary>
    public partial class GstIncomeType
    {
        /// <summary>
        /// Get the collection of imcome types.
        /// </summary>
        /// <returns>The collection of income types</returns>
        public virtual Extended.GstTypeList GetGstTypeList()
        {
            // Get the collection of income types.
            Data.GstIncomeType[] data = Select.SelectDataEntities();

            // Add the collection of imcome types.
            Extended.GstTypeList list = new Extended.GstTypeList();
            list.AddRange(data);
            return list;
        }
    }
