...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region UserType Data Extension Type
    /// <summary>
    /// The usertype replica object class.
    /// </summary>
    public partial class UserType : DataBase<Data.UserType>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.UserType> SelectContext;
        
        private IDeleteDataGenericBase<Data.UserType> DeleteContext;
        
        private IInsertDataGenericBase<Data.UserType> InsertContext;
        
        private IUpdateDataGenericBase<Data.UserType> UpdateContext;
        
        private ICommonDataGenericBase<Data.UserType> CommonContext;
        ...
        public UserType(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.UserType> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.UserType> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.UserType> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.UserType> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.UserType> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the usertype entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.UserType queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.UserType> QueryableProvider()
        {
            return new UserType().Select.QueryableProvider();
        }
    }
    #endregion
}
