...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region Customers Data Extension Type
    /// <summary>
    /// The customers replica object class.
    /// </summary>
    public partial class Customers : DataBase<Data.Customers>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Customers> SelectContext;
        
        private IDeleteDataGenericBase<Data.Customers> DeleteContext;
        
        private IInsertDataGenericBase<Data.Customers> InsertContext;
        
        private IUpdateDataGenericBase<Data.Customers> UpdateContext;
        
        private ICommonDataGenericBase<Data.Customers> CommonContext;
        ...
        public Customers(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Customers> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Customers> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Customers> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Customers> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Customers> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the customers entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.Customers queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Customers> QueryableProvider()
        {
            return new Customers().Select.QueryableProvider();
        }
    }
    #endregion
}
