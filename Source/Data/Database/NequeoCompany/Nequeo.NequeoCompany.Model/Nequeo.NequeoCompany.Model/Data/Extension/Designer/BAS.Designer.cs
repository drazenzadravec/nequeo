...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region BAS Data Extension Type
    /// <summary>
    /// The bas replica object class.
    /// </summary>
    public partial class BAS : DataBase<Data.BAS>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.BAS> SelectContext;
        
        private IDeleteDataGenericBase<Data.BAS> DeleteContext;
        
        private IInsertDataGenericBase<Data.BAS> InsertContext;
        
        private IUpdateDataGenericBase<Data.BAS> UpdateContext;
        
        private ICommonDataGenericBase<Data.BAS> CommonContext;
        ...
        public BAS(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.BAS> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.BAS> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.BAS> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.BAS> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.BAS> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the bas entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.BAS queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.BAS> QueryableProvider()
        {
            return new BAS().Select.QueryableProvider();
        }
    }
    #endregion
}
