...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region IncomeType Data Extension Type
    /// <summary>
    /// The incometype replica object class.
    /// </summary>
    public partial class IncomeType : DataBase<Data.IncomeType>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.IncomeType> SelectContext;
        
        private IDeleteDataGenericBase<Data.IncomeType> DeleteContext;
        
        private IInsertDataGenericBase<Data.IncomeType> InsertContext;
        
        private IUpdateDataGenericBase<Data.IncomeType> UpdateContext;
        
        private ICommonDataGenericBase<Data.IncomeType> CommonContext;
        ...
        public IncomeType(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.IncomeType> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.IncomeType> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.IncomeType> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.IncomeType> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.IncomeType> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the incometype entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.IncomeType queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.IncomeType> QueryableProvider()
        {
            return new IncomeType().Select.QueryableProvider();
        }
    }
    #endregion
}
