...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region Products Data Extension Type
    /// <summary>
    /// The products replica object class.
    /// </summary>
    public partial class Products : DataBase<Data.Products>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Products> SelectContext;
        
        private IDeleteDataGenericBase<Data.Products> DeleteContext;
        
        private IInsertDataGenericBase<Data.Products> InsertContext;
        
        private IUpdateDataGenericBase<Data.Products> UpdateContext;
        
        private ICommonDataGenericBase<Data.Products> CommonContext;
        ...
        public Products(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Products> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Products> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Products> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Products> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Products> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the products entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.Products queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Products> QueryableProvider()
        {
            return new Products().Select.QueryableProvider();
        }
    }
    #endregion
}
