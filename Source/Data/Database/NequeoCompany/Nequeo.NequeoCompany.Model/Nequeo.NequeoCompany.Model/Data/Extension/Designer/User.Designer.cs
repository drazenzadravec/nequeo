...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region User Data Extension Type
    /// <summary>
    /// The user replica object class.
    /// </summary>
    public partial class User : DataBase<Data.User>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.User> SelectContext;
        
        private IDeleteDataGenericBase<Data.User> DeleteContext;
        
        private IInsertDataGenericBase<Data.User> InsertContext;
        
        private IUpdateDataGenericBase<Data.User> UpdateContext;
        
        private ICommonDataGenericBase<Data.User> CommonContext;
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.User> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.User> Delete
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.User> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets the Data.User queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.User> QueryableProvider()
        {
            return new User().Select.QueryableProvider();
        }
    }
    #endregion
}
