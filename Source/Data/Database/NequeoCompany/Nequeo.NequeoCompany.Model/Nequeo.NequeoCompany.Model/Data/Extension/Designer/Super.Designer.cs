...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region Super Data Extension Type
    /// <summary>
    /// The super replica object class.
    /// </summary>
    public partial class Super : DataBase<Data.Super>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Super> SelectContext;
        
        private IDeleteDataGenericBase<Data.Super> DeleteContext;
        
        private IInsertDataGenericBase<Data.Super> InsertContext;
        
        private IUpdateDataGenericBase<Data.Super> UpdateContext;
        
        private ICommonDataGenericBase<Data.Super> CommonContext;
        ...
        public Super(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Super> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Super> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Super> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Super> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Super> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the super entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.Super queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Super> QueryableProvider()
        {
            return new Super().Select.QueryableProvider();
        }
    }
    #endregion
}
