...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region Wages DataSet Extension Type
    /// <summary>
    /// The Wages schema object class.
    /// </summary>
    public partial class Wages
    {
		private Nequeo.Threading.AsyncExecutionHandler<Wages> _asyncAccount = null;
        private Exception _exception = null;
		private WagesThread _threadWagesContext = null;
		...
		/// <summary>
        /// Gets the Wages threading context.
        /// </summary>
        public WagesThread WagesThreadContext
        {
            get { return _threadWagesContext; }
        }

		/// <summary>
        /// On create instance of Wages
        /// </summary>
		partial void OnCreated()
		{
			// Start the async control.
            _asyncAccount = new Nequeo.Threading.AsyncExecutionHandler<Wages>();
			...
			_threadWagesContext = new WagesThread(this);
			_threadWagesContext.AsyncError += new Threading.EventHandler<Exception>(_asyncAccount_AsyncError);
		}
        ...
        public virtual DataTransactions<Data.Wages> DelegateTransaction()
        {
           return new DataTransactions<Data.Wages>(
                    this.Insert, 
                    this.Delete, 
                    this.Update, 
                    this.Select);
		...
		/// <summary>
        /// Wages threading handler.
        /// </summary>
        public class WagesThread : Nequeo.Threading.AsyncExecutionHandler<Wages>
        {
            /// <summary>
            /// Wages threading handler.
            /// </summary>
            /// <param name="service">The Wages type.</param>
            public WagesThread(Wages service)
                : base(service) { }
        }
    }
    #endregion
