...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region EmployeeSuperAccounts Data Extension Type
    /// <summary>
    /// The employeesuperaccounts replica object class.
    /// </summary>
    public partial class EmployeeSuperAccounts : DataBase<Data.EmployeeSuperAccounts>, IDisposable
    {
        ...
        private string _connectionConfigKey = "Nequeo.DataAccess.NequeoCompany.Properties.Settings.NequeoCompanyDatabaseConnection";
        ...
        private ISelectDataGenericBase<Data.EmployeeSuperAccounts> SelectContext;
        
        private IDeleteDataGenericBase<Data.EmployeeSuperAccounts> DeleteContext;
        
        private IInsertDataGenericBase<Data.EmployeeSuperAccounts> InsertContext;
        
        private IUpdateDataGenericBase<Data.EmployeeSuperAccounts> UpdateContext;
        
        private ICommonDataGenericBase<Data.EmployeeSuperAccounts> CommonContext;
        ...
        public EmployeeSuperAccounts(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.EmployeeSuperAccounts> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.EmployeeSuperAccounts> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.EmployeeSuperAccounts> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.EmployeeSuperAccounts> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.EmployeeSuperAccounts> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the employeesuperaccounts entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.EmployeeSuperAccounts queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.EmployeeSuperAccounts> QueryableProvider()
        {
            return new EmployeeSuperAccounts().Select.QueryableProvider();
        }
    }
    #endregion
}
