...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region AssetCategory Data Extension Type
    /// <summary>
    /// The assetcategory replica object class.
    /// </summary>
    public partial class AssetCategory : DataBase<Data.AssetCategory>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.AssetCategory> SelectContext;
        
        private IDeleteDataGenericBase<Data.AssetCategory> DeleteContext;
        
        private IInsertDataGenericBase<Data.AssetCategory> InsertContext;
        
        private IUpdateDataGenericBase<Data.AssetCategory> UpdateContext;
        
        private ICommonDataGenericBase<Data.AssetCategory> CommonContext;
        ...
        public AssetCategory(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.AssetCategory> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.AssetCategory> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.AssetCategory> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.AssetCategory> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.AssetCategory> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the assetcategory entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.AssetCategory queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.AssetCategory> QueryableProvider()
        {
            return new AssetCategory().Select.QueryableProvider();
        }
    }
    #endregion
}
