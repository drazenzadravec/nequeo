...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region Wages Data Extension Type
    /// <summary>
    /// The wages replica object class.
    /// </summary>
    public partial class Wages : DataBase<Data.Wages>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Wages> SelectContext;
        
        private IDeleteDataGenericBase<Data.Wages> DeleteContext;
        
        private IInsertDataGenericBase<Data.Wages> InsertContext;
        
        private IUpdateDataGenericBase<Data.Wages> UpdateContext;
        
        private ICommonDataGenericBase<Data.Wages> CommonContext;
        ...
        public Wages(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Wages> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Wages> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Wages> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Wages> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Wages> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the wages entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.Wages queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Wages> QueryableProvider()
        {
            return new Wages().Select.QueryableProvider();
        }
    }
    #endregion
}
