...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region Accounts DataSet Extension Type
    /// <summary>
    /// The Accounts schema object class.
    /// </summary>
    public partial class Accounts
    {
		private Nequeo.Threading.AsyncExecutionHandler<Accounts> _asyncAccount = null;
        private Exception _exception = null;
		private AccountsThread _threadAccountsContext = null;
		...
		/// <summary>
        /// Gets the Accounts threading context.
        /// </summary>
        public AccountsThread AccountsThreadContext
        {
            get { return _threadAccountsContext; }
        }

		/// <summary>
        /// On create instance of Accounts
        /// </summary>
		partial void OnCreated()
		{
			// Start the async control.
            _asyncAccount = new Nequeo.Threading.AsyncExecutionHandler<Accounts>();
			...
			_threadAccountsContext = new AccountsThread(this);
			_threadAccountsContext.AsyncError += new Threading.EventHandler<Exception>(_asyncAccount_AsyncError);
		}
        ...
        public virtual DataTransactions<Data.Accounts> DelegateTransaction()
        {
           return new DataTransactions<Data.Accounts>(
                    this.Insert, 
                    this.Delete, 
                    this.Update, 
                    this.Select);
		...
		/// <summary>
        /// Accounts threading handler.
        /// </summary>
        public class AccountsThread : Nequeo.Threading.AsyncExecutionHandler<Accounts>
        {
            /// <summary>
            /// Accounts threading handler.
            /// </summary>
            /// <param name="service">The Accounts type.</param>
            public AccountsThread(Accounts service)
                : base(service) { }
        }
    }
    #endregion
