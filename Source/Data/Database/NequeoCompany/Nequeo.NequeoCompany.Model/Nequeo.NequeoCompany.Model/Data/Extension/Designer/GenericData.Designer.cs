...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region GenericData Data Extension Type
    /// <summary>
    /// The genericdata replica object class.
    /// </summary>
    public partial class GenericData : DataBase<Data.GenericData>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.GenericData> SelectContext;
        
        private IDeleteDataGenericBase<Data.GenericData> DeleteContext;
        
        private IInsertDataGenericBase<Data.GenericData> InsertContext;
        
        private IUpdateDataGenericBase<Data.GenericData> UpdateContext;
        
        private ICommonDataGenericBase<Data.GenericData> CommonContext;
        ...
        public GenericData(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.GenericData> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.GenericData> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.GenericData> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.GenericData> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.GenericData> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the genericdata entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.GenericData queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.GenericData> QueryableProvider()
        {
            return new GenericData().Select.QueryableProvider();
        }
    }
    #endregion
}
