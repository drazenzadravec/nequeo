...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region VendorDetails Data Extension Type
    /// <summary>
    /// The vendordetails replica object class.
    /// </summary>
    public partial class VendorDetails : DataBase<Data.VendorDetails>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.VendorDetails> SelectContext;
        
        private IDeleteDataGenericBase<Data.VendorDetails> DeleteContext;
        
        private IInsertDataGenericBase<Data.VendorDetails> InsertContext;
        
        private IUpdateDataGenericBase<Data.VendorDetails> UpdateContext;
        
        private ICommonDataGenericBase<Data.VendorDetails> CommonContext;
        ...
        public VendorDetails(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.VendorDetails> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.VendorDetails> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.VendorDetails> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.VendorDetails> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.VendorDetails> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the vendordetails entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.VendorDetails queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.VendorDetails> QueryableProvider()
        {
            return new VendorDetails().Select.QueryableProvider();
        }
    }
    #endregion
}
