...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region InvoiceDetails Data Extension Type
    /// <summary>
    /// The invoicedetails replica object class.
    /// </summary>
    public partial class InvoiceDetails : DataBase<Data.InvoiceDetails>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.InvoiceDetails> SelectContext;
        
        private IDeleteDataGenericBase<Data.InvoiceDetails> DeleteContext;
        
        private IInsertDataGenericBase<Data.InvoiceDetails> InsertContext;
        
        private IUpdateDataGenericBase<Data.InvoiceDetails> UpdateContext;
        
        private ICommonDataGenericBase<Data.InvoiceDetails> CommonContext;
        ...
        public InvoiceDetails(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.InvoiceDetails> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.InvoiceDetails> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.InvoiceDetails> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.InvoiceDetails> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.InvoiceDetails> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the invoicedetails entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.InvoiceDetails queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.InvoiceDetails> QueryableProvider()
        {
            return new InvoiceDetails().Select.QueryableProvider();
        }
    }
    #endregion
}
