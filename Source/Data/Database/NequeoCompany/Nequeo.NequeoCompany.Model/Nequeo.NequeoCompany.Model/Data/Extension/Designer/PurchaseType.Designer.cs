...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region PurchaseType Data Extension Type
    /// <summary>
    /// The purchasetype replica object class.
    /// </summary>
    public partial class PurchaseType : DataBase<Data.PurchaseType>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.PurchaseType> SelectContext;
        
        private IDeleteDataGenericBase<Data.PurchaseType> DeleteContext;
        
        private IInsertDataGenericBase<Data.PurchaseType> InsertContext;
        
        private IUpdateDataGenericBase<Data.PurchaseType> UpdateContext;
        
        private ICommonDataGenericBase<Data.PurchaseType> CommonContext;
        ...
        public PurchaseType(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.PurchaseType> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.PurchaseType> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.PurchaseType> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.PurchaseType> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.PurchaseType> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the purchasetype entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.PurchaseType queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.PurchaseType> QueryableProvider()
        {
            return new PurchaseType().Select.QueryableProvider();
        }
    }
    #endregion
}
