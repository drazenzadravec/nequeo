...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region AccountType Data Extension Type
    /// <summary>
    /// The accounttype replica object class.
    /// </summary>
    public partial class AccountType : DataBase<Data.AccountType>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.AccountType> SelectContext;
        
        private IDeleteDataGenericBase<Data.AccountType> DeleteContext;
        
        private IInsertDataGenericBase<Data.AccountType> InsertContext;
        
        private IUpdateDataGenericBase<Data.AccountType> UpdateContext;
        
        private ICommonDataGenericBase<Data.AccountType> CommonContext;
        ...
        public AccountType(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.AccountType> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.AccountType> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.AccountType> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.AccountType> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.AccountType> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the accounttype entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.AccountType queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.AccountType> QueryableProvider()
        {
            return new AccountType().Select.QueryableProvider();
        }
    }
    #endregion
}
