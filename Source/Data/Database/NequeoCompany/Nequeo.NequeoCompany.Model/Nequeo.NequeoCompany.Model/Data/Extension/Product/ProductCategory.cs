...
{
    /// <summary>
    /// The Product Category data member extension.
    /// </summary>
    public partial class ProductCategory
    {
        ...
        public virtual Extended.ProductCategoryType GetProductCategoryTypeList()
        {
            // Get the collection of income types.
            Data.ProductCategory[] data = Select.SelectDataEntities();

            // Add the collection of imcome types.
            Extended.ProductCategoryType list = new Extended.ProductCategoryType();
            list.AddRange(data);
            return list;
        }
    }
