...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region PaymentType Data Extension Type
    /// <summary>
    /// The paymenttype replica object class.
    /// </summary>
    public partial class PaymentType : DataBase<Data.PaymentType>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.PaymentType> SelectContext;
        
        private IDeleteDataGenericBase<Data.PaymentType> DeleteContext;
        
        private IInsertDataGenericBase<Data.PaymentType> InsertContext;
        
        private IUpdateDataGenericBase<Data.PaymentType> UpdateContext;
        
        private ICommonDataGenericBase<Data.PaymentType> CommonContext;
        ...
        public PaymentType(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.PaymentType> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.PaymentType> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.PaymentType> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.PaymentType> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.PaymentType> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the paymenttype entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.PaymentType queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.PaymentType> QueryableProvider()
        {
            return new PaymentType().Select.QueryableProvider();
        }
    }
    #endregion
}
