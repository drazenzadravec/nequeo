...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    {
        /// <summary>
        /// Get the collection of state types.
        /// </summary>
        /// <returns>The collection of state types</returns>
        public virtual Extended.StateTypeList GetStateTypeList()
        {
            // Get the collection of income types.
            Data.State[] data = Select.SelectDataEntities();

            // Add the collection of imcome types.
            Extended.StateTypeList list = new Extended.StateTypeList();
            list.AddRange(data);
            return list;
        }
    }
