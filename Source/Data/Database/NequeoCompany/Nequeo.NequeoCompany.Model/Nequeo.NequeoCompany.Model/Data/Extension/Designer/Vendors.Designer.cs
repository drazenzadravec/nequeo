...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region Vendors Data Extension Type
    /// <summary>
    /// The vendors replica object class.
    /// </summary>
    public partial class Vendors : DataBase<Data.Vendors>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Vendors> SelectContext;
        
        private IDeleteDataGenericBase<Data.Vendors> DeleteContext;
        
        private IInsertDataGenericBase<Data.Vendors> InsertContext;
        
        private IUpdateDataGenericBase<Data.Vendors> UpdateContext;
        
        private ICommonDataGenericBase<Data.Vendors> CommonContext;
        ...
        public Vendors(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Vendors> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Vendors> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Vendors> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Vendors> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Vendors> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the vendors entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.Vendors queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Vendors> QueryableProvider()
        {
            return new Vendors().Select.QueryableProvider();
        }
    }
    #endregion
}
