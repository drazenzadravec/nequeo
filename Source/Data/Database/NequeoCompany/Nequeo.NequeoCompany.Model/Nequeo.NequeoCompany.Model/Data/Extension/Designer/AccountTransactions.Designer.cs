...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region AccountTransactions Data Extension Type
    /// <summary>
    /// The accounttransactions replica object class.
    /// </summary>
    public partial class AccountTransactions : DataBase<Data.AccountTransactions>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.AccountTransactions> SelectContext;
        
        private IDeleteDataGenericBase<Data.AccountTransactions> DeleteContext;
        
        private IInsertDataGenericBase<Data.AccountTransactions> InsertContext;
        
        private IUpdateDataGenericBase<Data.AccountTransactions> UpdateContext;
        
        private ICommonDataGenericBase<Data.AccountTransactions> CommonContext;
        ...
        public AccountTransactions(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.AccountTransactions> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.AccountTransactions> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.AccountTransactions> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.AccountTransactions> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.AccountTransactions> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the accounttransactions entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.AccountTransactions queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.AccountTransactions> QueryableProvider()
        {
            return new AccountTransactions().Select.QueryableProvider();
        }
    }
    #endregion
}
