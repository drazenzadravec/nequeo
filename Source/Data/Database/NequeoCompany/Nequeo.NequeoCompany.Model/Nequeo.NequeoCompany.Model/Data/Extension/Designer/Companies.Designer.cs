...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region Companies Data Extension Type
    /// <summary>
    /// The companies replica object class.
    /// </summary>
    public partial class Companies : DataBase<Data.Companies>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Companies> SelectContext;
        
        private IDeleteDataGenericBase<Data.Companies> DeleteContext;
        
        private IInsertDataGenericBase<Data.Companies> InsertContext;
        
        private IUpdateDataGenericBase<Data.Companies> UpdateContext;
        
        private ICommonDataGenericBase<Data.Companies> CommonContext;
        ...
        public Companies(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Companies> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Companies> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Companies> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Companies> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Companies> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the companies entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.Companies queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Companies> QueryableProvider()
        {
            return new Companies().Select.QueryableProvider();
        }
    }
    #endregion
}
