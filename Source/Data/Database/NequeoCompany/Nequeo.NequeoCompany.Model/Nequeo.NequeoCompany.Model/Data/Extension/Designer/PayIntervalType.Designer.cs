...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region PayIntervalType Data Extension Type
    /// <summary>
    /// The payintervaltype replica object class.
    /// </summary>
    public partial class PayIntervalType : DataBase<Data.PayIntervalType>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.PayIntervalType> SelectContext;
        
        private IDeleteDataGenericBase<Data.PayIntervalType> DeleteContext;
        
        private IInsertDataGenericBase<Data.PayIntervalType> InsertContext;
        
        private IUpdateDataGenericBase<Data.PayIntervalType> UpdateContext;
        
        private ICommonDataGenericBase<Data.PayIntervalType> CommonContext;
        ...
        public PayIntervalType(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.PayIntervalType> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.PayIntervalType> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.PayIntervalType> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.PayIntervalType> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.PayIntervalType> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the payintervaltype entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.PayIntervalType queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.PayIntervalType> QueryableProvider()
        {
            return new PayIntervalType().Select.QueryableProvider();
        }
    }
    #endregion
}
