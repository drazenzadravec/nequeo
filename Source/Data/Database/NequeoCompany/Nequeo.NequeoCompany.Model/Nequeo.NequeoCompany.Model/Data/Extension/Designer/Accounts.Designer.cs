...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region Accounts Data Extension Type
    /// <summary>
    /// The accounts replica object class.
    /// </summary>
    public partial class Accounts : DataBase<Data.Accounts>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Accounts> SelectContext;
        
        private IDeleteDataGenericBase<Data.Accounts> DeleteContext;
        
        private IInsertDataGenericBase<Data.Accounts> InsertContext;
        
        private IUpdateDataGenericBase<Data.Accounts> UpdateContext;
        
        private ICommonDataGenericBase<Data.Accounts> CommonContext;
        ...
        public Accounts(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Accounts> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Accounts> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Accounts> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Accounts> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Accounts> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the accounts entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.Accounts queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Accounts> QueryableProvider()
        {
            return new Accounts().Select.QueryableProvider();
        }
    }
    #endregion
}
