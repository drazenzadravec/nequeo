...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region Assets Data Extension Type
    /// <summary>
    /// The assets replica object class.
    /// </summary>
    public partial class Assets : DataBase<Data.Assets>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Assets> SelectContext;
        
        private IDeleteDataGenericBase<Data.Assets> DeleteContext;
        
        private IInsertDataGenericBase<Data.Assets> InsertContext;
        
        private IUpdateDataGenericBase<Data.Assets> UpdateContext;
        
        private ICommonDataGenericBase<Data.Assets> CommonContext;
        ...
        public Assets(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Assets> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Assets> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Assets> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Assets> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Assets> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the assets entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.Assets queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Assets> QueryableProvider()
        {
            return new Assets().Select.QueryableProvider();
        }
    }
    #endregion
}
