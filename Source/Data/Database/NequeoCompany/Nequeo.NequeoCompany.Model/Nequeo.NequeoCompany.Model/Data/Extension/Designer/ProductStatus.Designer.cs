...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region ProductStatus Data Extension Type
    /// <summary>
    /// The productstatus replica object class.
    /// </summary>
    public partial class ProductStatus : DataBase<Data.ProductStatus>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.ProductStatus> SelectContext;
        
        private IDeleteDataGenericBase<Data.ProductStatus> DeleteContext;
        
        private IInsertDataGenericBase<Data.ProductStatus> InsertContext;
        
        private IUpdateDataGenericBase<Data.ProductStatus> UpdateContext;
        
        private ICommonDataGenericBase<Data.ProductStatus> CommonContext;
        ...
        public ProductStatus(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.ProductStatus> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.ProductStatus> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.ProductStatus> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.ProductStatus> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.ProductStatus> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the productstatus entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.ProductStatus queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.ProductStatus> QueryableProvider()
        {
            return new ProductStatus().Select.QueryableProvider();
        }
    }
    #endregion
}
