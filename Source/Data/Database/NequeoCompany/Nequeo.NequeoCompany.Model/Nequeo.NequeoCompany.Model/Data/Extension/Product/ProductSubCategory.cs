...
{
    /// <summary>
    /// The Product SubCategory data member extension.
    /// </summary>
    public partial class ProductSubCategory
    {
        ...
        public virtual Extended.ProductSubCategoryType GetProductSubCategoryTypeList()
        {
            // Get the collection of income types.
            Data.ProductSubCategory[] data = Select.SelectDataEntities();

            // Add the collection of imcome types.
            Extended.ProductSubCategoryType list = new Extended.ProductSubCategoryType();
            list.AddRange(data);
            return list;
        }
    }
