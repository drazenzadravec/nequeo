...
namespace Nequeo.DataAccess.NequeoCompany.Data.Extension
{
    ...
    #region Employees Data Extension Type
    /// <summary>
    /// The employees replica object class.
    /// </summary>
    public partial class Employees : DataBase<Data.Employees>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Employees> SelectContext;
        
        private IDeleteDataGenericBase<Data.Employees> DeleteContext;
        
        private IInsertDataGenericBase<Data.Employees> InsertContext;
        
        private IUpdateDataGenericBase<Data.Employees> UpdateContext;
        
        private ICommonDataGenericBase<Data.Employees> CommonContext;
        ...
        public Employees(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Employees> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Employees> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Employees> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Employees> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Employees> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the employees entity table property for the object.
        /// </summary>
        ...
        /// <summary>
        /// Gets the Data.Employees queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Employees> QueryableProvider()
        {
            return new Employees().Select.QueryableProvider();
        }
    }
    #endregion
}
