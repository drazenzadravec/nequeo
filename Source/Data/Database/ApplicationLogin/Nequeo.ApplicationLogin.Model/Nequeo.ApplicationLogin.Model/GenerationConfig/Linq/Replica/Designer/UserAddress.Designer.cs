...
namespace Nequeo.DataAccess.ApplicationLogin.Linq.Replica
{
    ...
    /// <summary>
    /// The useraddress replica object class.
    /// </summary>
    public partial class UserAddress : LinqGenericBase<Linq.CommonDataContext, Linq.UserAddress, Data.UserAddress>, IDisposable
    {
        ...
        private ISelectLinqGenericBase<Linq.CommonDataContext, Linq.UserAddress, Data.UserAddress> SelectContext;
        
        private IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.UserAddress, Data.UserAddress> DeleteContext;
        
        private IInsertLinqGenericBase<Linq.CommonDataContext, Linq.UserAddress, Data.UserAddress> InsertContext;
        
        private IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.UserAddress, Data.UserAddress> UpdateContext;
        
        private LinqDataGenericBase<Linq.CommonDataContext, Linq.UserAddress, Data.UserAddress> CommonContext;
        ...
        /// </summary>
        public new ISelectLinqGenericBase<Linq.CommonDataContext, Linq.UserAddress, Data.UserAddress> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.UserAddress, Data.UserAddress> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertLinqGenericBase<Linq.CommonDataContext, Linq.UserAddress, Data.UserAddress> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.UserAddress, Data.UserAddress> Update
        {
            get
            {
        ...
        /// </summary>
        public new LinqDataGenericBase<Linq.CommonDataContext, Linq.UserAddress, Data.UserAddress> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the useraddress entity table property for the object.
        /// </summary>
