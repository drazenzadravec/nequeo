...
namespace Nequeo.DataAccess.ApplicationLogin.Linq.Replica
{
    ...
    /// <summary>
    /// The department replica object class.
    /// </summary>
    public partial class Department : LinqGenericBase<Linq.CommonDataContext, Linq.Department, Data.Department>, IDisposable
    {
        ...
        private ISelectLinqGenericBase<Linq.CommonDataContext, Linq.Department, Data.Department> SelectContext;
        
        private IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.Department, Data.Department> DeleteContext;
        
        private IInsertLinqGenericBase<Linq.CommonDataContext, Linq.Department, Data.Department> InsertContext;
        
        private IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.Department, Data.Department> UpdateContext;
        
        private LinqDataGenericBase<Linq.CommonDataContext, Linq.Department, Data.Department> CommonContext;
        ...
        /// </summary>
        public new ISelectLinqGenericBase<Linq.CommonDataContext, Linq.Department, Data.Department> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.Department, Data.Department> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertLinqGenericBase<Linq.CommonDataContext, Linq.Department, Data.Department> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.Department, Data.Department> Update
        {
            get
            {
        ...
        /// </summary>
        public new LinqDataGenericBase<Linq.CommonDataContext, Linq.Department, Data.Department> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the department entity table property for the object.
        /// </summary>
