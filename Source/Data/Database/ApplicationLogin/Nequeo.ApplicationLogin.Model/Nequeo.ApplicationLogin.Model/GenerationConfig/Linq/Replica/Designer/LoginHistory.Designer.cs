...
namespace Nequeo.DataAccess.ApplicationLogin.Linq.Replica
{
    ...
    /// </summary>
    public partial class LoginHistory : LinqGenericBase<Linq.CommonDataContext, Linq.LoginHistory, Data.LoginHistory>, IDisposable
    {
        ...
        private ISelectLinqGenericBase<Linq.CommonDataContext, Linq.LoginHistory, Data.LoginHistory> SelectContext;
        
        private IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.LoginHistory, Data.LoginHistory> DeleteContext;
        
        private IInsertLinqGenericBase<Linq.CommonDataContext, Linq.LoginHistory, Data.LoginHistory> InsertContext;
        
        private IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.LoginHistory, Data.LoginHistory> UpdateContext;
        
        private LinqDataGenericBase<Linq.CommonDataContext, Linq.LoginHistory, Data.LoginHistory> CommonContext;
        ...
        /// </summary>
        public new ISelectLinqGenericBase<Linq.CommonDataContext, Linq.LoginHistory, Data.LoginHistory> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.LoginHistory, Data.LoginHistory> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertLinqGenericBase<Linq.CommonDataContext, Linq.LoginHistory, Data.LoginHistory> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.LoginHistory, Data.LoginHistory> Update
        {
            get
            {
        ...
        /// </summary>
        public new LinqDataGenericBase<Linq.CommonDataContext, Linq.LoginHistory, Data.LoginHistory> Common
        {
            get
            {
