...
namespace Nequeo.DataAccess.ApplicationLogin.Linq.Replica
{
    ...
    /// <summary>
    /// The country replica object class.
    /// </summary>
    public partial class Country : LinqGenericBase<Linq.CommonDataContext, Linq.Country, Data.Country>, IDisposable
    {
        ...
        private ISelectLinqGenericBase<Linq.CommonDataContext, Linq.Country, Data.Country> SelectContext;
        
        private IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.Country, Data.Country> DeleteContext;
        
        private IInsertLinqGenericBase<Linq.CommonDataContext, Linq.Country, Data.Country> InsertContext;
        
        private IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.Country, Data.Country> UpdateContext;
        
        private LinqDataGenericBase<Linq.CommonDataContext, Linq.Country, Data.Country> CommonContext;
        ...
        /// </summary>
        public new ISelectLinqGenericBase<Linq.CommonDataContext, Linq.Country, Data.Country> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.Country, Data.Country> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertLinqGenericBase<Linq.CommonDataContext, Linq.Country, Data.Country> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.Country, Data.Country> Update
        {
            get
            {
        ...
        /// </summary>
        public new LinqDataGenericBase<Linq.CommonDataContext, Linq.Country, Data.Country> Common
        {
            get
            {
