...
namespace Nequeo.DataAccess.ApplicationLogin.Linq.Replica
{
    ...
    /// </summary>
    public partial class Application : LinqGenericBase<Linq.CommonDataContext, Linq.Application, Data.Application>, IDisposable
    {
        ...
        private ISelectLinqGenericBase<Linq.CommonDataContext, Linq.Application, Data.Application> SelectContext;
        
        private IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.Application, Data.Application> DeleteContext;
        
        private IInsertLinqGenericBase<Linq.CommonDataContext, Linq.Application, Data.Application> InsertContext;
        
        private IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.Application, Data.Application> UpdateContext;
        
        private LinqDataGenericBase<Linq.CommonDataContext, Linq.Application, Data.Application> CommonContext;
        ...
        /// </summary>
        public new ISelectLinqGenericBase<Linq.CommonDataContext, Linq.Application, Data.Application> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.Application, Data.Application> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertLinqGenericBase<Linq.CommonDataContext, Linq.Application, Data.Application> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.Application, Data.Application> Update
        {
            get
            {
        ...
        /// </summary>
        public new LinqDataGenericBase<Linq.CommonDataContext, Linq.Application, Data.Application> Common
        {
            get
            {
