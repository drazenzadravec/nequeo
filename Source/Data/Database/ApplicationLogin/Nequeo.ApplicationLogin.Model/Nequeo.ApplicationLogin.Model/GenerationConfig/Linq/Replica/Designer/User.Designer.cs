...
namespace Nequeo.DataAccess.ApplicationLogin.Linq.Replica
{
    ...
    /// </summary>
    public partial class User : LinqGenericBase<Linq.CommonDataContext, Linq.User, Data.User>, IDisposable
    {
        ...
        private ISelectLinqGenericBase<Linq.CommonDataContext, Linq.User, Data.User> SelectContext;
        
        private IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.User, Data.User> DeleteContext;
        
        private IInsertLinqGenericBase<Linq.CommonDataContext, Linq.User, Data.User> InsertContext;
        
        private IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.User, Data.User> UpdateContext;
        
        private LinqDataGenericBase<Linq.CommonDataContext, Linq.User, Data.User> CommonContext;
        ...
        /// </summary>
        public new ISelectLinqGenericBase<Linq.CommonDataContext, Linq.User, Data.User> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.User, Data.User> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertLinqGenericBase<Linq.CommonDataContext, Linq.User, Data.User> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.User, Data.User> Update
        {
            get
            {
        ...
        /// </summary>
        public new LinqDataGenericBase<Linq.CommonDataContext, Linq.User, Data.User> Common
        {
            get
            {
