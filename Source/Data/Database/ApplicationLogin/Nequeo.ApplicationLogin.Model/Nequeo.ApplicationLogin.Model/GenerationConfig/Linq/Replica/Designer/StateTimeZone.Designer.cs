...
namespace Nequeo.DataAccess.ApplicationLogin.Linq.Replica
{
    ...
    /// <summary>
    /// The statetimezone replica object class.
    /// </summary>
    public partial class StateTimeZone : LinqGenericBase<Linq.CommonDataContext, Linq.StateTimeZone, Data.StateTimeZone>, IDisposable
    {
        ...
        private ISelectLinqGenericBase<Linq.CommonDataContext, Linq.StateTimeZone, Data.StateTimeZone> SelectContext;
        
        private IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.StateTimeZone, Data.StateTimeZone> DeleteContext;
        
        private IInsertLinqGenericBase<Linq.CommonDataContext, Linq.StateTimeZone, Data.StateTimeZone> InsertContext;
        
        private IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.StateTimeZone, Data.StateTimeZone> UpdateContext;
        
        private LinqDataGenericBase<Linq.CommonDataContext, Linq.StateTimeZone, Data.StateTimeZone> CommonContext;
        ...
        /// </summary>
        public new ISelectLinqGenericBase<Linq.CommonDataContext, Linq.StateTimeZone, Data.StateTimeZone> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.StateTimeZone, Data.StateTimeZone> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertLinqGenericBase<Linq.CommonDataContext, Linq.StateTimeZone, Data.StateTimeZone> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.StateTimeZone, Data.StateTimeZone> Update
        {
            get
            {
        ...
        /// </summary>
        public new LinqDataGenericBase<Linq.CommonDataContext, Linq.StateTimeZone, Data.StateTimeZone> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the statetimezone entity table property for the object.
        /// </summary>
