...
namespace Nequeo.DataAccess.ApplicationLogin.Linq.Replica
{
    ...
    /// <summary>
    /// The applicationuser replica object class.
    /// </summary>
    public partial class ApplicationUser : LinqGenericBase<Linq.CommonDataContext, Linq.ApplicationUser, Data.ApplicationUser>, IDisposable
    {
        ...
        private ISelectLinqGenericBase<Linq.CommonDataContext, Linq.ApplicationUser, Data.ApplicationUser> SelectContext;
        
        private IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.ApplicationUser, Data.ApplicationUser> DeleteContext;
        
        private IInsertLinqGenericBase<Linq.CommonDataContext, Linq.ApplicationUser, Data.ApplicationUser> InsertContext;
        
        private IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.ApplicationUser, Data.ApplicationUser> UpdateContext;
        
        private LinqDataGenericBase<Linq.CommonDataContext, Linq.ApplicationUser, Data.ApplicationUser> CommonContext;
        ...
        /// </summary>
        public new ISelectLinqGenericBase<Linq.CommonDataContext, Linq.ApplicationUser, Data.ApplicationUser> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.ApplicationUser, Data.ApplicationUser> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertLinqGenericBase<Linq.CommonDataContext, Linq.ApplicationUser, Data.ApplicationUser> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.ApplicationUser, Data.ApplicationUser> Update
        {
            get
            {
        ...
        /// </summary>
        public new LinqDataGenericBase<Linq.CommonDataContext, Linq.ApplicationUser, Data.ApplicationUser> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the applicationuser entity table property for the object.
        /// </summary>
