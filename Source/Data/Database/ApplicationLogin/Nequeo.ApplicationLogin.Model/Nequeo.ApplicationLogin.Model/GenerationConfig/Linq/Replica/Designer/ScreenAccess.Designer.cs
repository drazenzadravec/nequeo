...
namespace Nequeo.DataAccess.ApplicationLogin.Linq.Replica
{
    ...
    /// <summary>
    /// The screenaccess replica object class.
    /// </summary>
    public partial class ScreenAccess : LinqGenericBase<Linq.CommonDataContext, Linq.ScreenAccess, Data.ScreenAccess>, IDisposable
    {
        ...
        private ISelectLinqGenericBase<Linq.CommonDataContext, Linq.ScreenAccess, Data.ScreenAccess> SelectContext;
        
        private IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.ScreenAccess, Data.ScreenAccess> DeleteContext;
        
        private IInsertLinqGenericBase<Linq.CommonDataContext, Linq.ScreenAccess, Data.ScreenAccess> InsertContext;
        
        private IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.ScreenAccess, Data.ScreenAccess> UpdateContext;
        
        private LinqDataGenericBase<Linq.CommonDataContext, Linq.ScreenAccess, Data.ScreenAccess> CommonContext;
        ...
        /// </summary>
        public new ISelectLinqGenericBase<Linq.CommonDataContext, Linq.ScreenAccess, Data.ScreenAccess> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.ScreenAccess, Data.ScreenAccess> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertLinqGenericBase<Linq.CommonDataContext, Linq.ScreenAccess, Data.ScreenAccess> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.ScreenAccess, Data.ScreenAccess> Update
        {
            get
            {
        ...
        /// </summary>
        public new LinqDataGenericBase<Linq.CommonDataContext, Linq.ScreenAccess, Data.ScreenAccess> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the screenaccess entity table property for the object.
        /// </summary>
