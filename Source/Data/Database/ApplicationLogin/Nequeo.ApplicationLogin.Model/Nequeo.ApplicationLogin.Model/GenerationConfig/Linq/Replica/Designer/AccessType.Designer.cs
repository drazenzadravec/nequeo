...
namespace Nequeo.DataAccess.ApplicationLogin.Linq.Replica
{
    ...
    /// <summary>
    /// The accesstype replica object class.
    /// </summary>
    public partial class AccessType : LinqGenericBase<Linq.CommonDataContext, Linq.AccessType, Data.AccessType>, IDisposable
    {
        ...
        private ISelectLinqGenericBase<Linq.CommonDataContext, Linq.AccessType, Data.AccessType> SelectContext;
        
        private IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.AccessType, Data.AccessType> DeleteContext;
        
        private IInsertLinqGenericBase<Linq.CommonDataContext, Linq.AccessType, Data.AccessType> InsertContext;
        
        private IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.AccessType, Data.AccessType> UpdateContext;
        
        private LinqDataGenericBase<Linq.CommonDataContext, Linq.AccessType, Data.AccessType> CommonContext;
        ...
        /// </summary>
        public new ISelectLinqGenericBase<Linq.CommonDataContext, Linq.AccessType, Data.AccessType> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.AccessType, Data.AccessType> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertLinqGenericBase<Linq.CommonDataContext, Linq.AccessType, Data.AccessType> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.AccessType, Data.AccessType> Update
        {
            get
            {
        ...
        /// </summary>
        public new LinqDataGenericBase<Linq.CommonDataContext, Linq.AccessType, Data.AccessType> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the accesstype entity table property for the object.
        /// </summary>
