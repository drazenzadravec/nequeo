...
namespace Nequeo.DataAccess.ApplicationLogin.Linq.Replica
{
    ...
    /// </summary>
    public partial class State : LinqGenericBase<Linq.CommonDataContext, Linq.State, Data.State>, IDisposable
    {
        ...
        private ISelectLinqGenericBase<Linq.CommonDataContext, Linq.State, Data.State> SelectContext;
        
        private IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.State, Data.State> DeleteContext;
        
        private IInsertLinqGenericBase<Linq.CommonDataContext, Linq.State, Data.State> InsertContext;
        
        private IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.State, Data.State> UpdateContext;
        
        private LinqDataGenericBase<Linq.CommonDataContext, Linq.State, Data.State> CommonContext;
        ...
        /// </summary>
        public new ISelectLinqGenericBase<Linq.CommonDataContext, Linq.State, Data.State> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.State, Data.State> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertLinqGenericBase<Linq.CommonDataContext, Linq.State, Data.State> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.State, Data.State> Update
        {
            get
            {
        ...
        /// </summary>
        public new LinqDataGenericBase<Linq.CommonDataContext, Linq.State, Data.State> Common
        {
            get
            {
