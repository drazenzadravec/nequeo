...
namespace Nequeo.DataAccess.ApplicationLogin.Linq.Replica
{
    ...
    /// <summary>
    /// The errorlog replica object class.
    /// </summary>
    public partial class ErrorLog : LinqGenericBase<Linq.CommonDataContext, Linq.ErrorLog, Data.ErrorLog>, IDisposable
    {
        ...
        private ISelectLinqGenericBase<Linq.CommonDataContext, Linq.ErrorLog, Data.ErrorLog> SelectContext;
        
        private IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.ErrorLog, Data.ErrorLog> DeleteContext;
        
        private IInsertLinqGenericBase<Linq.CommonDataContext, Linq.ErrorLog, Data.ErrorLog> InsertContext;
        
        private IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.ErrorLog, Data.ErrorLog> UpdateContext;
        
        private LinqDataGenericBase<Linq.CommonDataContext, Linq.ErrorLog, Data.ErrorLog> CommonContext;
        ...
        /// </summary>
        public new ISelectLinqGenericBase<Linq.CommonDataContext, Linq.ErrorLog, Data.ErrorLog> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.ErrorLog, Data.ErrorLog> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertLinqGenericBase<Linq.CommonDataContext, Linq.ErrorLog, Data.ErrorLog> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.ErrorLog, Data.ErrorLog> Update
        {
            get
            {
        ...
        /// </summary>
        public new LinqDataGenericBase<Linq.CommonDataContext, Linq.ErrorLog, Data.ErrorLog> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the errorlog entity table property for the object.
        /// </summary>
