...
namespace Nequeo.DataAccess.ApplicationLogin.Linq.Replica
{
    ...
    /// <summary>
    /// The language replica object class.
    /// </summary>
    public partial class Language : LinqGenericBase<Linq.CommonDataContext, Linq.Language, Data.Language>, IDisposable
    {
        ...
        private ISelectLinqGenericBase<Linq.CommonDataContext, Linq.Language, Data.Language> SelectContext;
        
        private IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.Language, Data.Language> DeleteContext;
        
        private IInsertLinqGenericBase<Linq.CommonDataContext, Linq.Language, Data.Language> InsertContext;
        
        private IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.Language, Data.Language> UpdateContext;
        
        private LinqDataGenericBase<Linq.CommonDataContext, Linq.Language, Data.Language> CommonContext;
        ...
        /// </summary>
        public new ISelectLinqGenericBase<Linq.CommonDataContext, Linq.Language, Data.Language> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.Language, Data.Language> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertLinqGenericBase<Linq.CommonDataContext, Linq.Language, Data.Language> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.Language, Data.Language> Update
        {
            get
            {
        ...
        /// </summary>
        public new LinqDataGenericBase<Linq.CommonDataContext, Linq.Language, Data.Language> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the language entity table property for the object.
        /// </summary>
