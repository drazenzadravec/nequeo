...
namespace Nequeo.DataAccess.ApplicationLogin.Linq.Replica
{
    ...
    /// <summary>
    /// The screen replica object class.
    /// </summary>
    public partial class Screen : LinqGenericBase<Linq.CommonDataContext, Linq.Screen, Data.Screen>, IDisposable
    {
        ...
        private ISelectLinqGenericBase<Linq.CommonDataContext, Linq.Screen, Data.Screen> SelectContext;
        
        private IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.Screen, Data.Screen> DeleteContext;
        
        private IInsertLinqGenericBase<Linq.CommonDataContext, Linq.Screen, Data.Screen> InsertContext;
        
        private IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.Screen, Data.Screen> UpdateContext;
        
        private LinqDataGenericBase<Linq.CommonDataContext, Linq.Screen, Data.Screen> CommonContext;
        ...
        /// </summary>
        public new ISelectLinqGenericBase<Linq.CommonDataContext, Linq.Screen, Data.Screen> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteLinqGenericBase<Linq.CommonDataContext, Linq.Screen, Data.Screen> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertLinqGenericBase<Linq.CommonDataContext, Linq.Screen, Data.Screen> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateLinqGenericBase<Linq.CommonDataContext, Linq.Screen, Data.Screen> Update
        {
            get
            {
        ...
        /// </summary>
        public new LinqDataGenericBase<Linq.CommonDataContext, Linq.Screen, Data.Screen> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the screen entity table property for the object.
        /// </summary>
