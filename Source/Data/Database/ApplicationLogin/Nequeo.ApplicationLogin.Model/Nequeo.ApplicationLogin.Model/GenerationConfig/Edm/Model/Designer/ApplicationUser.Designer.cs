...
namespace Nequeo.DataAccess.ApplicationLogin.Edm.Model
{
    ...
    /// <summary>
    /// The applicationuser model object class.
    /// </summary>
    public partial class ApplicationUser : EdmGenericBase<Edm.CommonEntityContext, Edm.ApplicationUser, Data.ApplicationUser>, IDisposable
    {
        
        private const string modelItem = "_ApplicationUser";
        ...
        private ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.ApplicationUser, Data.ApplicationUser> SelectContext;
        
        private IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.ApplicationUser, Data.ApplicationUser> DeleteContext;
        
        private IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.ApplicationUser, Data.ApplicationUser> InsertContext;
        
        private IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.ApplicationUser, Data.ApplicationUser> UpdateContext;
        
        private EdmDataGenericBase<Edm.CommonEntityContext, Edm.ApplicationUser, Data.ApplicationUser> CommonContext;
        ...
        /// </summary>
        public new ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.ApplicationUser, Data.ApplicationUser> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.ApplicationUser, Data.ApplicationUser> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.ApplicationUser, Data.ApplicationUser> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.ApplicationUser, Data.ApplicationUser> Update
        {
            get
            {
        ...
        /// </summary>
        public new EdmDataGenericBase<Edm.CommonEntityContext, Edm.ApplicationUser, Data.ApplicationUser> Common
        {
            get
            {
