...
namespace Nequeo.DataAccess.ApplicationLogin.Edm.Model
{
    ...
    /// <summary>
    /// The loginhistory model object class.
    /// </summary>
    public partial class LoginHistory : EdmGenericBase<Edm.CommonEntityContext, Edm.LoginHistory, Data.LoginHistory>, IDisposable
    {
        
        private const string modelItem = "_LoginHistory";
        ...
        private ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.LoginHistory, Data.LoginHistory> SelectContext;
        
        private IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.LoginHistory, Data.LoginHistory> DeleteContext;
        
        private IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.LoginHistory, Data.LoginHistory> InsertContext;
        
        private IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.LoginHistory, Data.LoginHistory> UpdateContext;
        
        private EdmDataGenericBase<Edm.CommonEntityContext, Edm.LoginHistory, Data.LoginHistory> CommonContext;
        ...
        /// </summary>
        public new ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.LoginHistory, Data.LoginHistory> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.LoginHistory, Data.LoginHistory> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.LoginHistory, Data.LoginHistory> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.LoginHistory, Data.LoginHistory> Update
        {
            get
            {
        ...
        /// </summary>
        public new EdmDataGenericBase<Edm.CommonEntityContext, Edm.LoginHistory, Data.LoginHistory> Common
        {
            get
            {
