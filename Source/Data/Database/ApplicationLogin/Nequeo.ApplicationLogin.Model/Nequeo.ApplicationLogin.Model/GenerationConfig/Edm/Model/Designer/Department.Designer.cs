...
namespace Nequeo.DataAccess.ApplicationLogin.Edm.Model
{
    ...
    /// <summary>
    /// The department model object class.
    /// </summary>
    public partial class Department : EdmGenericBase<Edm.CommonEntityContext, Edm.Department, Data.Department>, IDisposable
    {
        
        private const string modelItem = "_Department";
        ...
        private ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.Department, Data.Department> SelectContext;
        
        private IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.Department, Data.Department> DeleteContext;
        
        private IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.Department, Data.Department> InsertContext;
        
        private IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.Department, Data.Department> UpdateContext;
        
        private EdmDataGenericBase<Edm.CommonEntityContext, Edm.Department, Data.Department> CommonContext;
        ...
        /// </summary>
        public new ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.Department, Data.Department> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.Department, Data.Department> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.Department, Data.Department> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.Department, Data.Department> Update
        {
            get
            {
        ...
        /// </summary>
        public new EdmDataGenericBase<Edm.CommonEntityContext, Edm.Department, Data.Department> Common
        {
            get
            {
