...
namespace Nequeo.DataAccess.ApplicationLogin.Edm.Model
{
    ...
    /// <summary>
    /// The useraddress model object class.
    /// </summary>
    public partial class UserAddress : EdmGenericBase<Edm.CommonEntityContext, Edm.UserAddress, Data.UserAddress>, IDisposable
    {
        
        private const string modelItem = "_UserAddress";
        ...
        private ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.UserAddress, Data.UserAddress> SelectContext;
        
        private IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.UserAddress, Data.UserAddress> DeleteContext;
        
        private IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.UserAddress, Data.UserAddress> InsertContext;
        
        private IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.UserAddress, Data.UserAddress> UpdateContext;
        
        private EdmDataGenericBase<Edm.CommonEntityContext, Edm.UserAddress, Data.UserAddress> CommonContext;
        ...
        /// </summary>
        public new ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.UserAddress, Data.UserAddress> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.UserAddress, Data.UserAddress> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.UserAddress, Data.UserAddress> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.UserAddress, Data.UserAddress> Update
        {
            get
            {
        ...
        /// </summary>
        public new EdmDataGenericBase<Edm.CommonEntityContext, Edm.UserAddress, Data.UserAddress> Common
        {
            get
            {
