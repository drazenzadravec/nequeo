...
namespace Nequeo.DataAccess.ApplicationLogin.Edm.Model
{
    ...
    /// <summary>
    /// The application model object class.
    /// </summary>
    public partial class Application : EdmGenericBase<Edm.CommonEntityContext, Edm.Application, Data.Application>, IDisposable
    {
        
        private const string modelItem = "_Application";
        ...
        private ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.Application, Data.Application> SelectContext;
        
        private IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.Application, Data.Application> DeleteContext;
        
        private IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.Application, Data.Application> InsertContext;
        
        private IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.Application, Data.Application> UpdateContext;
        
        private EdmDataGenericBase<Edm.CommonEntityContext, Edm.Application, Data.Application> CommonContext;
        ...
        /// </summary>
        public new ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.Application, Data.Application> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.Application, Data.Application> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.Application, Data.Application> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.Application, Data.Application> Update
        {
            get
            {
        ...
        /// </summary>
        public new EdmDataGenericBase<Edm.CommonEntityContext, Edm.Application, Data.Application> Common
        {
            get
            {
