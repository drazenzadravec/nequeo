...
namespace Nequeo.DataAccess.ApplicationLogin.Edm.Model
{
    ...
    /// </summary>
    public partial class Company : EdmGenericBase<Edm.CommonEntityContext, Edm.Company, Data.Company>, IDisposable
    {
        ...
        private ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.Company, Data.Company> SelectContext;
        
        private IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.Company, Data.Company> DeleteContext;
        
        private IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.Company, Data.Company> InsertContext;
        
        private IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.Company, Data.Company> UpdateContext;
        
        private EdmDataGenericBase<Edm.CommonEntityContext, Edm.Company, Data.Company> CommonContext;
        ...
        /// </summary>
        public new ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.Company, Data.Company> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.Company, Data.Company> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.Company, Data.Company> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.Company, Data.Company> Update
        {
            get
            {
        ...
        /// </summary>
        public new EdmDataGenericBase<Edm.CommonEntityContext, Edm.Company, Data.Company> Common
        {
            get
            {
