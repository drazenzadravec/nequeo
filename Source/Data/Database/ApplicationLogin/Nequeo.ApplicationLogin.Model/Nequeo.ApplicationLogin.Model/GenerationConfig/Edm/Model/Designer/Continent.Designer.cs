...
namespace Nequeo.DataAccess.ApplicationLogin.Edm.Model
{
    ...
    /// <summary>
    /// The continent model object class.
    /// </summary>
    public partial class Continent : EdmGenericBase<Edm.CommonEntityContext, Edm.Continent, Data.Continent>, IDisposable
    {
        
        private const string modelItem = "_Continent";
        ...
        private ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.Continent, Data.Continent> SelectContext;
        
        private IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.Continent, Data.Continent> DeleteContext;
        
        private IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.Continent, Data.Continent> InsertContext;
        
        private IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.Continent, Data.Continent> UpdateContext;
        
        private EdmDataGenericBase<Edm.CommonEntityContext, Edm.Continent, Data.Continent> CommonContext;
        ...
        /// </summary>
        public new ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.Continent, Data.Continent> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.Continent, Data.Continent> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.Continent, Data.Continent> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.Continent, Data.Continent> Update
        {
            get
            {
        ...
        /// </summary>
        public new EdmDataGenericBase<Edm.CommonEntityContext, Edm.Continent, Data.Continent> Common
        {
            get
            {
