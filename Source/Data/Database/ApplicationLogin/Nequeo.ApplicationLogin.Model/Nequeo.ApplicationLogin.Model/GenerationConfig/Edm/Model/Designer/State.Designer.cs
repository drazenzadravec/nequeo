...
namespace Nequeo.DataAccess.ApplicationLogin.Edm.Model
{
    ...
    /// <summary>
    /// The state model object class.
    /// </summary>
    public partial class State : EdmGenericBase<Edm.CommonEntityContext, Edm.State, Data.State>, IDisposable
    {
        
        private const string modelItem = "_State";
        ...
        private ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.State, Data.State> SelectContext;
        
        private IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.State, Data.State> DeleteContext;
        
        private IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.State, Data.State> InsertContext;
        
        private IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.State, Data.State> UpdateContext;
        
        private EdmDataGenericBase<Edm.CommonEntityContext, Edm.State, Data.State> CommonContext;
        ...
        /// </summary>
        public new ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.State, Data.State> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.State, Data.State> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.State, Data.State> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.State, Data.State> Update
        {
            get
            {
        ...
        /// </summary>
        public new EdmDataGenericBase<Edm.CommonEntityContext, Edm.State, Data.State> Common
        {
            get
            {
