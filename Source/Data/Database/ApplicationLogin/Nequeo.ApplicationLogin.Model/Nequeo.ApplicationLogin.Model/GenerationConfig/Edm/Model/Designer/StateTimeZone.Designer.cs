...
namespace Nequeo.DataAccess.ApplicationLogin.Edm.Model
{
    ...
    /// <summary>
    /// The statetimezone model object class.
    /// </summary>
    public partial class StateTimeZone : EdmGenericBase<Edm.CommonEntityContext, Edm.StateTimeZone, Data.StateTimeZone>, IDisposable
    {
        
        private const string modelItem = "_StateTimeZone";
        ...
        private ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.StateTimeZone, Data.StateTimeZone> SelectContext;
        
        private IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.StateTimeZone, Data.StateTimeZone> DeleteContext;
        
        private IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.StateTimeZone, Data.StateTimeZone> InsertContext;
        
        private IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.StateTimeZone, Data.StateTimeZone> UpdateContext;
        
        private EdmDataGenericBase<Edm.CommonEntityContext, Edm.StateTimeZone, Data.StateTimeZone> CommonContext;
        ...
        /// </summary>
        public new ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.StateTimeZone, Data.StateTimeZone> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.StateTimeZone, Data.StateTimeZone> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.StateTimeZone, Data.StateTimeZone> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.StateTimeZone, Data.StateTimeZone> Update
        {
            get
            {
        ...
        /// </summary>
        public new EdmDataGenericBase<Edm.CommonEntityContext, Edm.StateTimeZone, Data.StateTimeZone> Common
        {
            get
            {
