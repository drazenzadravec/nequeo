...
namespace Nequeo.DataAccess.ApplicationLogin.Edm.Model
{
    ...
    /// <summary>
    /// The accesstype model object class.
    /// </summary>
    public partial class AccessType : EdmGenericBase<Edm.CommonEntityContext, Edm.AccessType, Data.AccessType>, IDisposable
    {
        
        private const string modelItem = "_AccessType";
        ...
        private ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.AccessType, Data.AccessType> SelectContext;
        
        private IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.AccessType, Data.AccessType> DeleteContext;
        
        private IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.AccessType, Data.AccessType> InsertContext;
        
        private IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.AccessType, Data.AccessType> UpdateContext;
        
        private EdmDataGenericBase<Edm.CommonEntityContext, Edm.AccessType, Data.AccessType> CommonContext;
        ...
        /// </summary>
        public new ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.AccessType, Data.AccessType> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.AccessType, Data.AccessType> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.AccessType, Data.AccessType> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.AccessType, Data.AccessType> Update
        {
            get
            {
        ...
        /// </summary>
        public new EdmDataGenericBase<Edm.CommonEntityContext, Edm.AccessType, Data.AccessType> Common
        {
            get
            {
