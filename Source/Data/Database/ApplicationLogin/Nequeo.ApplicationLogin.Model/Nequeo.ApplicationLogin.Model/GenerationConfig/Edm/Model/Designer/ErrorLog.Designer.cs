...
namespace Nequeo.DataAccess.ApplicationLogin.Edm.Model
{
    ...
    /// <summary>
    /// The errorlog model object class.
    /// </summary>
    public partial class ErrorLog : EdmGenericBase<Edm.CommonEntityContext, Edm.ErrorLog, Data.ErrorLog>, IDisposable
    {
        
        private const string modelItem = "_ErrorLog";
        ...
        private ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.ErrorLog, Data.ErrorLog> SelectContext;
        
        private IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.ErrorLog, Data.ErrorLog> DeleteContext;
        
        private IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.ErrorLog, Data.ErrorLog> InsertContext;
        
        private IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.ErrorLog, Data.ErrorLog> UpdateContext;
        
        private EdmDataGenericBase<Edm.CommonEntityContext, Edm.ErrorLog, Data.ErrorLog> CommonContext;
        ...
        /// </summary>
        public new ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.ErrorLog, Data.ErrorLog> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.ErrorLog, Data.ErrorLog> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.ErrorLog, Data.ErrorLog> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.ErrorLog, Data.ErrorLog> Update
        {
            get
            {
        ...
        /// </summary>
        public new EdmDataGenericBase<Edm.CommonEntityContext, Edm.ErrorLog, Data.ErrorLog> Common
        {
            get
            {
