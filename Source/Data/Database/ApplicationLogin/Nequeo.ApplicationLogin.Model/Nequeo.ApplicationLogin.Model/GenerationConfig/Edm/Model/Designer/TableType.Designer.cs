...
namespace Nequeo.DataAccess.ApplicationLogin.Edm.Model
{
    ...
    /// <summary>
    /// The tabletype model object class.
    /// </summary>
    public partial class TableType : EdmGenericBase<Edm.CommonEntityContext, Edm.TableType, Data.TableType>, IDisposable
    {
        
        private const string modelItem = "_TableType";
        ...
        private ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.TableType, Data.TableType> SelectContext;
        
        private IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.TableType, Data.TableType> DeleteContext;
        
        private IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.TableType, Data.TableType> InsertContext;
        
        private IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.TableType, Data.TableType> UpdateContext;
        
        private EdmDataGenericBase<Edm.CommonEntityContext, Edm.TableType, Data.TableType> CommonContext;
        ...
        /// </summary>
        public new ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.TableType, Data.TableType> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.TableType, Data.TableType> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.TableType, Data.TableType> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.TableType, Data.TableType> Update
        {
            get
            {
        ...
        /// </summary>
        public new EdmDataGenericBase<Edm.CommonEntityContext, Edm.TableType, Data.TableType> Common
        {
            get
            {
