...
namespace Nequeo.DataAccess.ApplicationLogin.Edm.Model
{
    ...
    /// <summary>
    /// The screenaccess model object class.
    /// </summary>
    public partial class ScreenAccess : EdmGenericBase<Edm.CommonEntityContext, Edm.ScreenAccess, Data.ScreenAccess>, IDisposable
    {
        
        private const string modelItem = "_ScreenAccess";
        ...
        private ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.ScreenAccess, Data.ScreenAccess> SelectContext;
        
        private IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.ScreenAccess, Data.ScreenAccess> DeleteContext;
        
        private IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.ScreenAccess, Data.ScreenAccess> InsertContext;
        
        private IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.ScreenAccess, Data.ScreenAccess> UpdateContext;
        
        private EdmDataGenericBase<Edm.CommonEntityContext, Edm.ScreenAccess, Data.ScreenAccess> CommonContext;
        ...
        /// </summary>
        public new ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.ScreenAccess, Data.ScreenAccess> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.ScreenAccess, Data.ScreenAccess> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.ScreenAccess, Data.ScreenAccess> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.ScreenAccess, Data.ScreenAccess> Update
        {
            get
            {
        ...
        /// </summary>
        public new EdmDataGenericBase<Edm.CommonEntityContext, Edm.ScreenAccess, Data.ScreenAccess> Common
        {
            get
            {
