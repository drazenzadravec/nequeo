...
namespace Nequeo.DataAccess.ApplicationLogin.Edm.Model
{
    ...
    /// <summary>
    /// The language model object class.
    /// </summary>
    public partial class Language : EdmGenericBase<Edm.CommonEntityContext, Edm.Language, Data.Language>, IDisposable
    {
        
        private const string modelItem = "_Language";
        ...
        private ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.Language, Data.Language> SelectContext;
        
        private IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.Language, Data.Language> DeleteContext;
        
        private IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.Language, Data.Language> InsertContext;
        
        private IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.Language, Data.Language> UpdateContext;
        
        private EdmDataGenericBase<Edm.CommonEntityContext, Edm.Language, Data.Language> CommonContext;
        ...
        /// </summary>
        public new ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.Language, Data.Language> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.Language, Data.Language> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.Language, Data.Language> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.Language, Data.Language> Update
        {
            get
            {
        ...
        /// </summary>
        public new EdmDataGenericBase<Edm.CommonEntityContext, Edm.Language, Data.Language> Common
        {
            get
            {
