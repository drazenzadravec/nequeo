...
namespace Nequeo.DataAccess.ApplicationLogin.Edm.Model
{
    ...
    /// <summary>
    /// The screen model object class.
    /// </summary>
    public partial class Screen : EdmGenericBase<Edm.CommonEntityContext, Edm.Screen, Data.Screen>, IDisposable
    {
        
        private const string modelItem = "_Screen";
        ...
        private ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.Screen, Data.Screen> SelectContext;
        
        private IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.Screen, Data.Screen> DeleteContext;
        
        private IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.Screen, Data.Screen> InsertContext;
        
        private IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.Screen, Data.Screen> UpdateContext;
        
        private EdmDataGenericBase<Edm.CommonEntityContext, Edm.Screen, Data.Screen> CommonContext;
        ...
        /// </summary>
        public new ISelectEdmGenericBase<Edm.CommonEntityContext, Edm.Screen, Data.Screen> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteEdmGenericBase<Edm.CommonEntityContext, Edm.Screen, Data.Screen> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertEdmGenericBase<Edm.CommonEntityContext, Edm.Screen, Data.Screen> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateEdmGenericBase<Edm.CommonEntityContext, Edm.Screen, Data.Screen> Update
        {
            get
            {
        ...
        /// </summary>
        public new EdmDataGenericBase<Edm.CommonEntityContext, Edm.Screen, Data.Screen> Common
        {
            get
            {
