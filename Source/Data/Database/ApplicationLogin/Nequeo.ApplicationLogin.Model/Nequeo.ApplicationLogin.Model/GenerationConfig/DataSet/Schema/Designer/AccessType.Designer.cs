...
namespace Nequeo.DataAccess.ApplicationLogin.DataSet.Schema
{
    ...
    /// <summary>
    /// The accesstype schema object class.
    /// </summary>
    public partial class AccessType : DataSetGenericBase<DataSet.Common, DataSet.Common.AccessTypeDataTable, Data.AccessType>, IDisposable
    {
        
        private const string schemaItem = "_AccessType";
        ...
        private ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.AccessTypeDataTable, Data.AccessType> SelectContext;
        
        private IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.AccessTypeDataTable, Data.AccessType> DeleteContext;
        
        private IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.AccessTypeDataTable, Data.AccessType> InsertContext;
        
        private IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.AccessTypeDataTable, Data.AccessType> UpdateContext;
        
        private DataSetDataGenericBase<DataSet.Common, DataSet.Common.AccessTypeDataTable, Data.AccessType> CommonContext;
        ...
        public AccessType(string connectionConfigKey, DataContextBase.ConnectionType connectionType, DataContextBase.ConnectionDataType connectionDataType) : 
        ...
        /// </summary>
        public new ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.AccessTypeDataTable, Data.AccessType> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.AccessTypeDataTable, Data.AccessType> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.AccessTypeDataTable, Data.AccessType> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.AccessTypeDataTable, Data.AccessType> Update
        {
            get
            {
        ...
        /// </summary>
        public new DataSetDataGenericBase<DataSet.Common, DataSet.Common.AccessTypeDataTable, Data.AccessType> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the accesstype dataset table property for the object.
        /// </summary>
