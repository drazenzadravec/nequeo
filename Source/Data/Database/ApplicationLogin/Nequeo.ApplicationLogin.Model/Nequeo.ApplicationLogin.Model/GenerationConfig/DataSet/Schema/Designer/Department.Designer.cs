...
namespace Nequeo.DataAccess.ApplicationLogin.DataSet.Schema
{
    ...
    /// <summary>
    /// The department schema object class.
    /// </summary>
    public partial class Department : DataSetGenericBase<DataSet.Common, DataSet.Common.DepartmentDataTable, Data.Department>, IDisposable
    {
        
        private const string schemaItem = "_Department";
        ...
        private ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.DepartmentDataTable, Data.Department> SelectContext;
        
        private IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.DepartmentDataTable, Data.Department> DeleteContext;
        
        private IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.DepartmentDataTable, Data.Department> InsertContext;
        
        private IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.DepartmentDataTable, Data.Department> UpdateContext;
        
        private DataSetDataGenericBase<DataSet.Common, DataSet.Common.DepartmentDataTable, Data.Department> CommonContext;
        ...
        public Department(string connectionConfigKey, DataContextBase.ConnectionType connectionType, DataContextBase.ConnectionDataType connectionDataType) : 
        ...
        /// </summary>
        public new ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.DepartmentDataTable, Data.Department> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.DepartmentDataTable, Data.Department> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.DepartmentDataTable, Data.Department> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.DepartmentDataTable, Data.Department> Update
        {
            get
            {
        ...
        /// </summary>
        public new DataSetDataGenericBase<DataSet.Common, DataSet.Common.DepartmentDataTable, Data.Department> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the department dataset table property for the object.
        /// </summary>
