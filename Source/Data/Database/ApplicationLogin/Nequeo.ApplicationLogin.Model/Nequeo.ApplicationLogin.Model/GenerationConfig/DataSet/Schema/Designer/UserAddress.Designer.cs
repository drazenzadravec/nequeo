...
namespace Nequeo.DataAccess.ApplicationLogin.DataSet.Schema
{
    ...
    /// <summary>
    /// The useraddress schema object class.
    /// </summary>
    public partial class UserAddress : DataSetGenericBase<DataSet.Common, DataSet.Common.UserAddressDataTable, Data.UserAddress>, IDisposable
    {
        
        private const string schemaItem = "_UserAddress";
        ...
        private ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.UserAddressDataTable, Data.UserAddress> SelectContext;
        
        private IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.UserAddressDataTable, Data.UserAddress> DeleteContext;
        
        private IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.UserAddressDataTable, Data.UserAddress> InsertContext;
        
        private IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.UserAddressDataTable, Data.UserAddress> UpdateContext;
        
        private DataSetDataGenericBase<DataSet.Common, DataSet.Common.UserAddressDataTable, Data.UserAddress> CommonContext;
        ...
        public UserAddress(string connectionConfigKey, DataContextBase.ConnectionType connectionType, DataContextBase.ConnectionDataType connectionDataType) : 
        ...
        /// </summary>
        public new ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.UserAddressDataTable, Data.UserAddress> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.UserAddressDataTable, Data.UserAddress> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.UserAddressDataTable, Data.UserAddress> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.UserAddressDataTable, Data.UserAddress> Update
        {
            get
            {
        ...
        /// </summary>
        public new DataSetDataGenericBase<DataSet.Common, DataSet.Common.UserAddressDataTable, Data.UserAddress> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the useraddress dataset table property for the object.
        /// </summary>
