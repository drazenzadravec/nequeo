...
namespace Nequeo.DataAccess.ApplicationLogin.DataSet.Schema
{
    ...
    /// <summary>
    /// The user schema object class.
    /// </summary>
    public partial class User : DataSetGenericBase<DataSet.Common, DataSet.Common.UserDataTable, Data.User>, IDisposable
    {
        
        private const string schemaItem = "_User";
        ...
        private ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.UserDataTable, Data.User> SelectContext;
        
        private IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.UserDataTable, Data.User> DeleteContext;
        
        private IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.UserDataTable, Data.User> InsertContext;
        
        private IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.UserDataTable, Data.User> UpdateContext;
        
        private DataSetDataGenericBase<DataSet.Common, DataSet.Common.UserDataTable, Data.User> CommonContext;
        ...
        /// </summary>
        public new ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.UserDataTable, Data.User> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.UserDataTable, Data.User> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.UserDataTable, Data.User> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.UserDataTable, Data.User> Update
        {
            get
            {
        ...
        /// </summary>
        public new DataSetDataGenericBase<DataSet.Common, DataSet.Common.UserDataTable, Data.User> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the user dataset table property for the object.
        /// </summary>
