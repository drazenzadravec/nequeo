...
namespace Nequeo.DataAccess.ApplicationLogin.DataSet.Schema
{
    ...
    /// <summary>
    /// The errorlog schema object class.
    /// </summary>
    public partial class ErrorLog : DataSetGenericBase<DataSet.Common, DataSet.Common.ErrorLogDataTable, Data.ErrorLog>, IDisposable
    {
        
        private const string schemaItem = "_ErrorLog";
        ...
        private ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.ErrorLogDataTable, Data.ErrorLog> SelectContext;
        
        private IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.ErrorLogDataTable, Data.ErrorLog> DeleteContext;
        
        private IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.ErrorLogDataTable, Data.ErrorLog> InsertContext;
        
        private IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.ErrorLogDataTable, Data.ErrorLog> UpdateContext;
        
        private DataSetDataGenericBase<DataSet.Common, DataSet.Common.ErrorLogDataTable, Data.ErrorLog> CommonContext;
        ...
        public ErrorLog(string connectionConfigKey, DataContextBase.ConnectionType connectionType, DataContextBase.ConnectionDataType connectionDataType) : 
        ...
        /// </summary>
        public new ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.ErrorLogDataTable, Data.ErrorLog> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.ErrorLogDataTable, Data.ErrorLog> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.ErrorLogDataTable, Data.ErrorLog> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.ErrorLogDataTable, Data.ErrorLog> Update
        {
            get
            {
        ...
        /// </summary>
        public new DataSetDataGenericBase<DataSet.Common, DataSet.Common.ErrorLogDataTable, Data.ErrorLog> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the errorlog dataset table property for the object.
        /// </summary>
