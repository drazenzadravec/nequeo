...
namespace Nequeo.DataAccess.ApplicationLogin.DataSet.Schema
{
    ...
    /// <summary>
    /// The language schema object class.
    /// </summary>
    public partial class Language : DataSetGenericBase<DataSet.Common, DataSet.Common.LanguageDataTable, Data.Language>, IDisposable
    {
        
        private const string schemaItem = "_Language";
        ...
        private ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.LanguageDataTable, Data.Language> SelectContext;
        
        private IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.LanguageDataTable, Data.Language> DeleteContext;
        
        private IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.LanguageDataTable, Data.Language> InsertContext;
        
        private IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.LanguageDataTable, Data.Language> UpdateContext;
        
        private DataSetDataGenericBase<DataSet.Common, DataSet.Common.LanguageDataTable, Data.Language> CommonContext;
        ...
        public Language(string connectionConfigKey, DataContextBase.ConnectionType connectionType, DataContextBase.ConnectionDataType connectionDataType) : 
        ...
        /// </summary>
        public new ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.LanguageDataTable, Data.Language> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.LanguageDataTable, Data.Language> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.LanguageDataTable, Data.Language> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.LanguageDataTable, Data.Language> Update
        {
            get
            {
        ...
        /// </summary>
        public new DataSetDataGenericBase<DataSet.Common, DataSet.Common.LanguageDataTable, Data.Language> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the language dataset table property for the object.
        /// </summary>
