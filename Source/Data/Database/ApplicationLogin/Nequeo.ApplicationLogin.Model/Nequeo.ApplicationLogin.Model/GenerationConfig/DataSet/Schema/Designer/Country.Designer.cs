...
namespace Nequeo.DataAccess.ApplicationLogin.DataSet.Schema
{
    ...
    /// <summary>
    /// The country schema object class.
    /// </summary>
    public partial class Country : DataSetGenericBase<DataSet.Common, DataSet.Common.CountryDataTable, Data.Country>, IDisposable
    {
        
        private const string schemaItem = "_Country";
        ...
        private ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.CountryDataTable, Data.Country> SelectContext;
        
        private IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.CountryDataTable, Data.Country> DeleteContext;
        
        private IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.CountryDataTable, Data.Country> InsertContext;
        
        private IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.CountryDataTable, Data.Country> UpdateContext;
        
        private DataSetDataGenericBase<DataSet.Common, DataSet.Common.CountryDataTable, Data.Country> CommonContext;
        ...
        /// </summary>
        public new ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.CountryDataTable, Data.Country> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.CountryDataTable, Data.Country> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.CountryDataTable, Data.Country> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.CountryDataTable, Data.Country> Update
        {
            get
            {
        ...
        /// </summary>
        public new DataSetDataGenericBase<DataSet.Common, DataSet.Common.CountryDataTable, Data.Country> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the country dataset table property for the object.
        /// </summary>
