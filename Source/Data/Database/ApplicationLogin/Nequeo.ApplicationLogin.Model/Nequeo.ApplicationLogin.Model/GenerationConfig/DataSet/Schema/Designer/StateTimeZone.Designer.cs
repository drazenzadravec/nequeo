...
namespace Nequeo.DataAccess.ApplicationLogin.DataSet.Schema
{
    ...
    /// <summary>
    /// The statetimezone schema object class.
    /// </summary>
    public partial class StateTimeZone : DataSetGenericBase<DataSet.Common, DataSet.Common.StateTimeZoneDataTable, Data.StateTimeZone>, IDisposable
    {
        
        private const string schemaItem = "_StateTimeZone";
        ...
        private ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.StateTimeZoneDataTable, Data.StateTimeZone> SelectContext;
        
        private IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.StateTimeZoneDataTable, Data.StateTimeZone> DeleteContext;
        
        private IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.StateTimeZoneDataTable, Data.StateTimeZone> InsertContext;
        
        private IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.StateTimeZoneDataTable, Data.StateTimeZone> UpdateContext;
        
        private DataSetDataGenericBase<DataSet.Common, DataSet.Common.StateTimeZoneDataTable, Data.StateTimeZone> CommonContext;
        ...
        public StateTimeZone(string connectionConfigKey, DataContextBase.ConnectionType connectionType, DataContextBase.ConnectionDataType connectionDataType) : 
        ...
        /// </summary>
        public new ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.StateTimeZoneDataTable, Data.StateTimeZone> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.StateTimeZoneDataTable, Data.StateTimeZone> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.StateTimeZoneDataTable, Data.StateTimeZone> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.StateTimeZoneDataTable, Data.StateTimeZone> Update
        {
            get
            {
        ...
        /// </summary>
        public new DataSetDataGenericBase<DataSet.Common, DataSet.Common.StateTimeZoneDataTable, Data.StateTimeZone> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the statetimezone dataset table property for the object.
        /// </summary>
