...
namespace Nequeo.DataAccess.ApplicationLogin.DataSet.Schema
{
    ...
    /// <summary>
    /// The loginhistory schema object class.
    /// </summary>
    public partial class LoginHistory : DataSetGenericBase<DataSet.Common, DataSet.Common.LoginHistoryDataTable, Data.LoginHistory>, IDisposable
    {
        
        private const string schemaItem = "_LoginHistory";
        ...
        private ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.LoginHistoryDataTable, Data.LoginHistory> SelectContext;
        
        private IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.LoginHistoryDataTable, Data.LoginHistory> DeleteContext;
        
        private IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.LoginHistoryDataTable, Data.LoginHistory> InsertContext;
        
        private IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.LoginHistoryDataTable, Data.LoginHistory> UpdateContext;
        
        private DataSetDataGenericBase<DataSet.Common, DataSet.Common.LoginHistoryDataTable, Data.LoginHistory> CommonContext;
        ...
        /// </summary>
        public new ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.LoginHistoryDataTable, Data.LoginHistory> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.LoginHistoryDataTable, Data.LoginHistory> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.LoginHistoryDataTable, Data.LoginHistory> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.LoginHistoryDataTable, Data.LoginHistory> Update
        {
            get
            {
        ...
        /// </summary>
        public new DataSetDataGenericBase<DataSet.Common, DataSet.Common.LoginHistoryDataTable, Data.LoginHistory> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the loginhistory dataset table property for the object.
        /// </summary>
