...
namespace Nequeo.DataAccess.ApplicationLogin.DataSet.Schema
{
    ...
    /// <summary>
    /// The application schema object class.
    /// </summary>
    public partial class Application : DataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationDataTable, Data.Application>, IDisposable
    {
        
        private const string schemaItem = "_Application";
        ...
        private ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationDataTable, Data.Application> SelectContext;
        
        private IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationDataTable, Data.Application> DeleteContext;
        
        private IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationDataTable, Data.Application> InsertContext;
        
        private IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationDataTable, Data.Application> UpdateContext;
        
        private DataSetDataGenericBase<DataSet.Common, DataSet.Common.ApplicationDataTable, Data.Application> CommonContext;
        ...
        /// </summary>
        public new ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationDataTable, Data.Application> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationDataTable, Data.Application> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationDataTable, Data.Application> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationDataTable, Data.Application> Update
        {
            get
            {
        ...
        /// </summary>
        public new DataSetDataGenericBase<DataSet.Common, DataSet.Common.ApplicationDataTable, Data.Application> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the application dataset table property for the object.
        /// </summary>
