...
namespace Nequeo.DataAccess.ApplicationLogin.DataSet.Schema
{
    ...
    /// <summary>
    /// The applicationuser schema object class.
    /// </summary>
    public partial class ApplicationUser : DataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationUserDataTable, Data.ApplicationUser>, IDisposable
    {
        
        private const string schemaItem = "_ApplicationUser";
        ...
        private ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationUserDataTable, Data.ApplicationUser> SelectContext;
        
        private IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationUserDataTable, Data.ApplicationUser> DeleteContext;
        
        private IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationUserDataTable, Data.ApplicationUser> InsertContext;
        
        private IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationUserDataTable, Data.ApplicationUser> UpdateContext;
        
        private DataSetDataGenericBase<DataSet.Common, DataSet.Common.ApplicationUserDataTable, Data.ApplicationUser> CommonContext;
        ...
        public ApplicationUser(string connectionConfigKey, DataContextBase.ConnectionType connectionType, DataContextBase.ConnectionDataType connectionDataType) : 
        ...
        /// </summary>
        public new ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationUserDataTable, Data.ApplicationUser> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationUserDataTable, Data.ApplicationUser> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationUserDataTable, Data.ApplicationUser> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.ApplicationUserDataTable, Data.ApplicationUser> Update
        {
            get
            {
        ...
        /// </summary>
        public new DataSetDataGenericBase<DataSet.Common, DataSet.Common.ApplicationUserDataTable, Data.ApplicationUser> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the applicationuser dataset table property for the object.
        /// </summary>
