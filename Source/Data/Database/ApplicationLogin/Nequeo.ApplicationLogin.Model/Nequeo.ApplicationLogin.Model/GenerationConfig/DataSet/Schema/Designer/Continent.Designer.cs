...
namespace Nequeo.DataAccess.ApplicationLogin.DataSet.Schema
{
    ...
    /// <summary>
    /// The continent schema object class.
    /// </summary>
    public partial class Continent : DataSetGenericBase<DataSet.Common, DataSet.Common.ContinentDataTable, Data.Continent>, IDisposable
    {
        
        private const string schemaItem = "_Continent";
        ...
        private ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.ContinentDataTable, Data.Continent> SelectContext;
        
        private IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.ContinentDataTable, Data.Continent> DeleteContext;
        
        private IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.ContinentDataTable, Data.Continent> InsertContext;
        
        private IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.ContinentDataTable, Data.Continent> UpdateContext;
        
        private DataSetDataGenericBase<DataSet.Common, DataSet.Common.ContinentDataTable, Data.Continent> CommonContext;
        ...
        public Continent(string connectionConfigKey, DataContextBase.ConnectionType connectionType, DataContextBase.ConnectionDataType connectionDataType) : 
        ...
        /// </summary>
        public new ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.ContinentDataTable, Data.Continent> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.ContinentDataTable, Data.Continent> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.ContinentDataTable, Data.Continent> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.ContinentDataTable, Data.Continent> Update
        {
            get
            {
        ...
        /// </summary>
        public new DataSetDataGenericBase<DataSet.Common, DataSet.Common.ContinentDataTable, Data.Continent> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the continent dataset table property for the object.
        /// </summary>
