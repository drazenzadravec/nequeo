...
namespace Nequeo.DataAccess.ApplicationLogin.DataSet.Schema
{
    ...
    /// <summary>
    /// The screen schema object class.
    /// </summary>
    public partial class Screen : DataSetGenericBase<DataSet.Common, DataSet.Common.ScreenDataTable, Data.Screen>, IDisposable
    {
        
        private const string schemaItem = "_Screen";
        ...
        private ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenDataTable, Data.Screen> SelectContext;
        
        private IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenDataTable, Data.Screen> DeleteContext;
        
        private IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenDataTable, Data.Screen> InsertContext;
        
        private IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenDataTable, Data.Screen> UpdateContext;
        
        private DataSetDataGenericBase<DataSet.Common, DataSet.Common.ScreenDataTable, Data.Screen> CommonContext;
        ...
        public Screen(string connectionConfigKey, DataContextBase.ConnectionType connectionType, DataContextBase.ConnectionDataType connectionDataType) : 
        ...
        /// </summary>
        public new ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenDataTable, Data.Screen> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenDataTable, Data.Screen> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenDataTable, Data.Screen> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenDataTable, Data.Screen> Update
        {
            get
            {
        ...
        /// </summary>
        public new DataSetDataGenericBase<DataSet.Common, DataSet.Common.ScreenDataTable, Data.Screen> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the screen dataset table property for the object.
        /// </summary>
