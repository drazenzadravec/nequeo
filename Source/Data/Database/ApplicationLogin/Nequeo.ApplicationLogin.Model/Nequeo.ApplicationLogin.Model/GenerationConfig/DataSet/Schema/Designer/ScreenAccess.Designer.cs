...
namespace Nequeo.DataAccess.ApplicationLogin.DataSet.Schema
{
    ...
    /// <summary>
    /// The screenaccess schema object class.
    /// </summary>
    public partial class ScreenAccess : DataSetGenericBase<DataSet.Common, DataSet.Common.ScreenAccessDataTable, Data.ScreenAccess>, IDisposable
    {
        
        private const string schemaItem = "_ScreenAccess";
        ...
        private ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenAccessDataTable, Data.ScreenAccess> SelectContext;
        
        private IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenAccessDataTable, Data.ScreenAccess> DeleteContext;
        
        private IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenAccessDataTable, Data.ScreenAccess> InsertContext;
        
        private IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenAccessDataTable, Data.ScreenAccess> UpdateContext;
        
        private DataSetDataGenericBase<DataSet.Common, DataSet.Common.ScreenAccessDataTable, Data.ScreenAccess> CommonContext;
        ...
        public ScreenAccess(string connectionConfigKey, DataContextBase.ConnectionType connectionType, DataContextBase.ConnectionDataType connectionDataType) : 
        ...
        /// </summary>
        public new ISelectDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenAccessDataTable, Data.ScreenAccess> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenAccessDataTable, Data.ScreenAccess> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenAccessDataTable, Data.ScreenAccess> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataSetGenericBase<DataSet.Common, DataSet.Common.ScreenAccessDataTable, Data.ScreenAccess> Update
        {
            get
            {
        ...
        /// </summary>
        public new DataSetDataGenericBase<DataSet.Common, DataSet.Common.ScreenAccessDataTable, Data.ScreenAccess> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets, the screenaccess dataset table property for the object.
        /// </summary>
