...
namespace Nequeo.DataAccess.ApplicationLogin.Data.Extension
{
    ...
    #region Company Data Extension Type
    /// <summary>
    /// The company replica object class.
    /// </summary>
    public partial class Company : DataBase<Data.Company>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Company> SelectContext;
        
        private IDeleteDataGenericBase<Data.Company> DeleteContext;
        
        private IInsertDataGenericBase<Data.Company> InsertContext;
        
        private IUpdateDataGenericBase<Data.Company> UpdateContext;
        
        private ICommonDataGenericBase<Data.Company> CommonContext;
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Company> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Company> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Company> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Company> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Company> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets the Data.Company queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Company> QueryableProvider()
        {
            return new Company().Select.QueryableProvider();
        }
    }
    #endregion
}
