...
namespace Nequeo.DataAccess.ApplicationLogin.Data.Extension
{
    ...
    #region ApplicationUser Data Extension Type
    /// <summary>
    /// The applicationuser replica object class.
    /// </summary>
    public partial class ApplicationUser : DataBase<Data.ApplicationUser>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.ApplicationUser> SelectContext;
        
        private IDeleteDataGenericBase<Data.ApplicationUser> DeleteContext;
        
        private IInsertDataGenericBase<Data.ApplicationUser> InsertContext;
        
        private IUpdateDataGenericBase<Data.ApplicationUser> UpdateContext;
        
        private ICommonDataGenericBase<Data.ApplicationUser> CommonContext;
        ...
        public ApplicationUser(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.ApplicationUser> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.ApplicationUser> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.ApplicationUser> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.ApplicationUser> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.ApplicationUser> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets the Data.ApplicationUser queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.ApplicationUser> QueryableProvider()
        {
            return new ApplicationUser().Select.QueryableProvider();
        }
    }
    #endregion
}
