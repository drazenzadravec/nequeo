...
namespace Nequeo.DataAccess.ApplicationLogin.Data.Extension
{
    ...
    #region UserAddress Data Extension Type
    /// <summary>
    /// The useraddress replica object class.
    /// </summary>
    public partial class UserAddress : DataBase<Data.UserAddress>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.UserAddress> SelectContext;
        
        private IDeleteDataGenericBase<Data.UserAddress> DeleteContext;
        
        private IInsertDataGenericBase<Data.UserAddress> InsertContext;
        
        private IUpdateDataGenericBase<Data.UserAddress> UpdateContext;
        
        private ICommonDataGenericBase<Data.UserAddress> CommonContext;
        ...
        public UserAddress(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.UserAddress> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.UserAddress> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.UserAddress> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.UserAddress> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.UserAddress> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets the Data.UserAddress queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.UserAddress> QueryableProvider()
        {
            return new UserAddress().Select.QueryableProvider();
        }
    }
    #endregion
}
