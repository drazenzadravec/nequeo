...
namespace Nequeo.DataAccess.ApplicationLogin.Data.Extension
{
    ...
    #region Country Data Extension Type
    /// <summary>
    /// The country replica object class.
    /// </summary>
    public partial class Country : DataBase<Data.Country>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Country> SelectContext;
        
        private IDeleteDataGenericBase<Data.Country> DeleteContext;
        
        private IInsertDataGenericBase<Data.Country> InsertContext;
        
        private IUpdateDataGenericBase<Data.Country> UpdateContext;
        
        private ICommonDataGenericBase<Data.Country> CommonContext;
        ...
        public Country(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Country> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Country> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Country> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Country> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Country> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets the Data.Country queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Country> QueryableProvider()
        {
            return new Country().Select.QueryableProvider();
        }
    }
    #endregion
}
