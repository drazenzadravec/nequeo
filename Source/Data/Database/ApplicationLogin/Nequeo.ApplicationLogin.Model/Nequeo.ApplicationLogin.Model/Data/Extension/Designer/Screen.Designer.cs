...
namespace Nequeo.DataAccess.ApplicationLogin.Data.Extension
{
    ...
    #region Screen Data Extension Type
    /// <summary>
    /// The screen replica object class.
    /// </summary>
    public partial class Screen : DataBase<Data.Screen>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Screen> SelectContext;
        
        private IDeleteDataGenericBase<Data.Screen> DeleteContext;
        
        private IInsertDataGenericBase<Data.Screen> InsertContext;
        
        private IUpdateDataGenericBase<Data.Screen> UpdateContext;
        
        private ICommonDataGenericBase<Data.Screen> CommonContext;
        ...
        public Screen(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Screen> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Screen> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Screen> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Screen> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Screen> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets the Data.Screen queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Screen> QueryableProvider()
        {
            return new Screen().Select.QueryableProvider();
        }
    }
    #endregion
}
