...
namespace Nequeo.DataAccess.ApplicationLogin.Data.Extension
{
    ...
    #region Continent Data Extension Type
    /// <summary>
    /// The continent replica object class.
    /// </summary>
    public partial class Continent : DataBase<Data.Continent>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Continent> SelectContext;
        
        private IDeleteDataGenericBase<Data.Continent> DeleteContext;
        
        private IInsertDataGenericBase<Data.Continent> InsertContext;
        
        private IUpdateDataGenericBase<Data.Continent> UpdateContext;
        
        private ICommonDataGenericBase<Data.Continent> CommonContext;
        ...
        public Continent(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Continent> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Continent> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Continent> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Continent> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Continent> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets the Data.Continent queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Continent> QueryableProvider()
        {
            return new Continent().Select.QueryableProvider();
        }
    }
    #endregion
}
