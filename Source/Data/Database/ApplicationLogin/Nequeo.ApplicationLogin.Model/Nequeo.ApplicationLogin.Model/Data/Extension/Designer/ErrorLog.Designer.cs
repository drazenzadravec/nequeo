...
namespace Nequeo.DataAccess.ApplicationLogin.Data.Extension
{
    ...
    #region ErrorLog Data Extension Type
    /// <summary>
    /// The errorlog replica object class.
    /// </summary>
    public partial class ErrorLog : DataBase<Data.ErrorLog>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.ErrorLog> SelectContext;
        
        private IDeleteDataGenericBase<Data.ErrorLog> DeleteContext;
        
        private IInsertDataGenericBase<Data.ErrorLog> InsertContext;
        
        private IUpdateDataGenericBase<Data.ErrorLog> UpdateContext;
        
        private ICommonDataGenericBase<Data.ErrorLog> CommonContext;
        ...
        public ErrorLog(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.ErrorLog> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.ErrorLog> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.ErrorLog> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.ErrorLog> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.ErrorLog> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets the Data.ErrorLog queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.ErrorLog> QueryableProvider()
        {
            return new ErrorLog().Select.QueryableProvider();
        }
    }
    #endregion
}
