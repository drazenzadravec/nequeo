...
namespace Nequeo.DataAccess.ApplicationLogin.Data.Extension
{
    ...
    #region TableType Data Extension Type
    /// <summary>
    /// The tabletype replica object class.
    /// </summary>
    public partial class TableType : DataBase<Data.TableType>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.TableType> SelectContext;
        
        private IDeleteDataGenericBase<Data.TableType> DeleteContext;
        
        private IInsertDataGenericBase<Data.TableType> InsertContext;
        
        private IUpdateDataGenericBase<Data.TableType> UpdateContext;
        
        private ICommonDataGenericBase<Data.TableType> CommonContext;
        ...
        public TableType(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.TableType> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.TableType> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.TableType> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.TableType> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.TableType> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets the Data.TableType queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.TableType> QueryableProvider()
        {
            return new TableType().Select.QueryableProvider();
        }
    }
    #endregion
}
