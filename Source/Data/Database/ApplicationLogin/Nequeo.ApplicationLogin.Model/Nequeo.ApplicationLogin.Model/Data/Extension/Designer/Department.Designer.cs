...
namespace Nequeo.DataAccess.ApplicationLogin.Data.Extension
{
    ...
    #region Department Data Extension Type
    /// <summary>
    /// The department replica object class.
    /// </summary>
    public partial class Department : DataBase<Data.Department>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Department> SelectContext;
        
        private IDeleteDataGenericBase<Data.Department> DeleteContext;
        
        private IInsertDataGenericBase<Data.Department> InsertContext;
        
        private IUpdateDataGenericBase<Data.Department> UpdateContext;
        
        private ICommonDataGenericBase<Data.Department> CommonContext;
        ...
        public Department(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Department> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Department> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Department> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Department> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Department> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets the Data.Department queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Department> QueryableProvider()
        {
            return new Department().Select.QueryableProvider();
        }
    }
    #endregion
}
