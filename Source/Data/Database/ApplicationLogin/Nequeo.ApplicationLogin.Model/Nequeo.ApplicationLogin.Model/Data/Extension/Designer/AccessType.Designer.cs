...
namespace Nequeo.DataAccess.ApplicationLogin.Data.Extension
{
    ...
    #region AccessType Data Extension Type
    /// <summary>
    /// The accesstype replica object class.
    /// </summary>
    public partial class AccessType : DataBase<Data.AccessType>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.AccessType> SelectContext;
        
        private IDeleteDataGenericBase<Data.AccessType> DeleteContext;
        
        private IInsertDataGenericBase<Data.AccessType> InsertContext;
        
        private IUpdateDataGenericBase<Data.AccessType> UpdateContext;
        
        private ICommonDataGenericBase<Data.AccessType> CommonContext;
        ...
        public AccessType(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.AccessType> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.AccessType> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.AccessType> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.AccessType> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.AccessType> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets the Data.AccessType queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.AccessType> QueryableProvider()
        {
            return new AccessType().Select.QueryableProvider();
        }
    }
    #endregion
}
