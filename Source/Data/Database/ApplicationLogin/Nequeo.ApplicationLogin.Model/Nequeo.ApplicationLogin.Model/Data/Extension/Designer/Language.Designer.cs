...
namespace Nequeo.DataAccess.ApplicationLogin.Data.Extension
{
    ...
    #region Language Data Extension Type
    /// <summary>
    /// The language replica object class.
    /// </summary>
    public partial class Language : DataBase<Data.Language>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.Language> SelectContext;
        
        private IDeleteDataGenericBase<Data.Language> DeleteContext;
        
        private IInsertDataGenericBase<Data.Language> InsertContext;
        
        private IUpdateDataGenericBase<Data.Language> UpdateContext;
        
        private ICommonDataGenericBase<Data.Language> CommonContext;
        ...
        public Language(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.Language> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.Language> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.Language> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.Language> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.Language> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets the Data.Language queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.Language> QueryableProvider()
        {
            return new Language().Select.QueryableProvider();
        }
    }
    #endregion
}
