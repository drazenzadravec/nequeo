...
namespace Nequeo.DataAccess.ApplicationLogin.Data.Extension
{
    ...
    #region StateTimeZone Data Extension Type
    /// <summary>
    /// The statetimezone replica object class.
    /// </summary>
    public partial class StateTimeZone : DataBase<Data.StateTimeZone>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.StateTimeZone> SelectContext;
        
        private IDeleteDataGenericBase<Data.StateTimeZone> DeleteContext;
        
        private IInsertDataGenericBase<Data.StateTimeZone> InsertContext;
        
        private IUpdateDataGenericBase<Data.StateTimeZone> UpdateContext;
        
        private ICommonDataGenericBase<Data.StateTimeZone> CommonContext;
        ...
        public StateTimeZone(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.StateTimeZone> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.StateTimeZone> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.StateTimeZone> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.StateTimeZone> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.StateTimeZone> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets the Data.StateTimeZone queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.StateTimeZone> QueryableProvider()
        {
            return new StateTimeZone().Select.QueryableProvider();
        }
    }
    #endregion
}
