...
namespace Nequeo.DataAccess.ApplicationLogin.Data.Extension
{
    ...
    #region ScreenAccess Data Extension Type
    /// <summary>
    /// The screenaccess replica object class.
    /// </summary>
    public partial class ScreenAccess : DataBase<Data.ScreenAccess>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.ScreenAccess> SelectContext;
        
        private IDeleteDataGenericBase<Data.ScreenAccess> DeleteContext;
        
        private IInsertDataGenericBase<Data.ScreenAccess> InsertContext;
        
        private IUpdateDataGenericBase<Data.ScreenAccess> UpdateContext;
        
        private ICommonDataGenericBase<Data.ScreenAccess> CommonContext;
        ...
        public ScreenAccess(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.ScreenAccess> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.ScreenAccess> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.ScreenAccess> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.ScreenAccess> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.ScreenAccess> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets the Data.ScreenAccess queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.ScreenAccess> QueryableProvider()
        {
            return new ScreenAccess().Select.QueryableProvider();
        }
    }
    #endregion
}
