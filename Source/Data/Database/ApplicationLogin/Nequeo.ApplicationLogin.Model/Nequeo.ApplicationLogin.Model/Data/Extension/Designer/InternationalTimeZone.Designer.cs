...
namespace Nequeo.DataAccess.ApplicationLogin.Data.Extension
{
    ...
    #region InternationalTimeZone Data Extension Type
    /// <summary>
    /// The internationaltimezone replica object class.
    /// </summary>
    public partial class InternationalTimeZone : DataBase<Data.InternationalTimeZone>, IDisposable
    {
        ...
        private ISelectDataGenericBase<Data.InternationalTimeZone> SelectContext;
        
        private IDeleteDataGenericBase<Data.InternationalTimeZone> DeleteContext;
        
        private IInsertDataGenericBase<Data.InternationalTimeZone> InsertContext;
        
        private IUpdateDataGenericBase<Data.InternationalTimeZone> UpdateContext;
        
        private ICommonDataGenericBase<Data.InternationalTimeZone> CommonContext;
        ...
        public InternationalTimeZone(string connectionConfigKey, Nequeo.Data.DataType.ConnectionContext.ConnectionType connectionType, Nequeo.Data.DataType.ConnectionContext.ConnectionDataType connectionDataType, Nequeo.Data.DataType.IDataAccess dataAccessProvider) : 
        ...
        /// </summary>
        public new ISelectDataGenericBase<Data.InternationalTimeZone> Select
        {
            get
            {
        ...
        /// </summary>
        public new IDeleteDataGenericBase<Data.InternationalTimeZone> Delete
        {
            get
            {
        ...
        /// </summary>
        public new IInsertDataGenericBase<Data.InternationalTimeZone> Insert
        {
            get
            {
        ...
        /// </summary>
        public new IUpdateDataGenericBase<Data.InternationalTimeZone> Update
        {
            get
            {
        ...
        /// </summary>
        public new ICommonDataGenericBase<Data.InternationalTimeZone> Common
        {
            get
            {
        ...
        /// <summary>
        /// Gets the Data.InternationalTimeZone queryable provider.
        /// </summary>
        /// <returns>The object queryable provider.</returns>
        public static Nequeo.Linq.QueryableProvider<Data.InternationalTimeZone> QueryableProvider()
        {
            return new InternationalTimeZone().Select.QueryableProvider();
        }
    }
    #endregion
}
