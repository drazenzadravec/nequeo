========================================================================
    ACTIVE TEMPLATE LIBRARY : QStat Project Overview
========================================================================

AppWizard has created this QStat project for you to use as the starting point for
...
_QStat.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_QStat.h)
        GUID definitions                                (_QStat_i.c)
        A type library                                  (_QStat.tlb)
        Marshaling code                                 (_QStat_p.c and dlldata.c)
QStat.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named QStat.pch and a precompiled types file named StdAfx.obj.
...
QStatps.vcproj
	...
	dlldata.c, QStat_i.c and QStat_p.c which are required
