...
{
    /// <summary>
    /// Represents a dialog containing a <see cref="PreviewControl"/> control
    ...
    public partial class PreviewDialog : Form
    {
        ...
        /// <summary>
        /// Initializes a new instance of a <see cref="PreviewDialog"/>.
        /// </summary>
        public PreviewDialog() : this(null)
        {
        }
        /// <summary>
        /// Initializes a new instance of a <see cref="PreviewDialog"/>.
        ...
        public PreviewDialog(Control parentForm)
        {
            InitializeComponent();
            if (parentForm != null)
            {
