...
namespace Nequeo.IO.Audio.Wave
{
    ...
    internal class WasapiCapture : IWaveIn
    {
        ...
        /// </summary>
        public virtual WaveFormatProvider WaveFormat 
        {
            get
            {
        ...
        public static MMDevice GetDefaultCaptureDevice()
        {
            ...
            return devices.GetDefaultAudioEndpoint(EDataFlow.Capture, ERole.Console);
        }
        ...
        private void ReadNextPacket(AudioCaptureClient capture)
        {
            ...
            while (packetSize != 0)
            {
                ...
                int spaceRemaining = System.Math.Max(0, recordBuffer.Length - recordBufferOffset);
