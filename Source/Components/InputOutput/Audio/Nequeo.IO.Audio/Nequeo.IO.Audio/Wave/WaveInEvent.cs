...
namespace Nequeo.IO.Audio.Wave
{
    ...
    internal class WaveInEvent : IWaveIn
    {
        ...
        public WaveInEvent()
        {
            ...
            this.DeviceNumber = 0;
            this.WaveFormat = new WaveFormatProvider(8000, 16, 1);
        ...
        private void OpenWaveInDevice()
        {
            ...
            MmResult result = WaveInterop.waveInOpenWindow(out waveInHandle, (IntPtr)DeviceNumber, WaveFormat, 
                callbackEvent.SafeWaitHandle.DangerousGetHandle(), IntPtr.Zero, WaveInOutOpenFlags.CallbackEvent);
        ...
        /// </summary>
        public WaveFormatProvider WaveFormat { get; set; }
