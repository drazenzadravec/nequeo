...
namespace Nequeo.IO.Audio.Utils
{
    ...
    internal static class IEEE
    {
        ...
        {
            return x * System.Math.Pow(2, exp);
        }

        private static double frexp(double x, out int exp)
        {
            exp = (int)System.Math.Floor(System.Math.Log(x) / System.Math.Log(2)) + 1;
            return 1 - (System.Math.Pow(2, exp) - x) / System.Math.Pow(2, exp);
        }
        ...
        public static byte[] ConvertToIeeeExtended(double num)
        {
            ...
            else
            {
                ...
                {    // Finite 
                    ...
                    fsMant = System.Math.Floor(fMant);
