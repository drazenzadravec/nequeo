...
#else
#	define NAMESPACE_BEGIN(x) namespace Nequeo { namespace Cryptography { namespace Core { namespace x {
#	define NAMESPACE_END }}}}
#	define NAMESPACE_BEGIN_EX(x, y) namespace Nequeo { namespace Cryptography { namespace Core { namespace x { namespace y {
#	define NAMESPACE_END_EX }}}}}
#	define DOCUMENTED_TYPEDEF(x, y) typedef x y;
#endif
#define ANONYMOUS_NAMESPACE_BEGIN namespace {
#define ANONYMOUS_NAMESPACE_END }
#define USING_NAMESPACE(x) using namespace Nequeo::Cryptography::Core::x;
#define DOCUMENTED_NAMESPACE_BEGIN(x) namespace Nequeo { namespace Cryptography { namespace Core { namespace x {
