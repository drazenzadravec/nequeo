...
using Nequeo.Cryptography.Key.Math.EC.Multiplier;

namespace Nequeo.Cryptography.Key.Math.EC
{
	/**
...
//			F2mFieldElement.CheckFieldElements(a.x, b.x);
		...
		/* (non-Javadoc)
		 * @see Nequeo.Cryptography.Key.math.ec.ECPoint#add(Nequeo.Cryptography.Key.math.ec.ECPoint)
		 */
		...
		/* (non-Javadoc)
		 * @see Nequeo.Cryptography.Key.math.ec.ECPoint#subtract(Nequeo.Cryptography.Key.math.ec.ECPoint)
		 */
		public override ECPoint Subtract(
			ECPoint b)
		{
