...
namespace Nequeo.Cryptography.Key.Bcpg.OpenPgp
{
    ...
    public class PgpSecretKey
    {
		...
		public PgpSecretKey(
            ...
            : this(certificationLevel, keyPair, id, encAlgorithm, passPhrase, false, hashedPackets, unhashedPackets, rand, hashAlgorithm)
		{
		}
		...
		public PgpSecretKey(
            ...
            : this(certificationLevel,
                ...
                id, encAlgorithm, passPhrase, hashedPackets, unhashedPackets, rand, hashAlgorithm)
        {
        }
		...
		public PgpSecretKey(
			...
			SecureRandom				rand,
            HashAlgorithmTag            hashAlgorithm)
            : this(certificationLevel, new PgpKeyPair(algorithm, pubKey, privKey, time), id, encAlgorithm, passPhrase, useSha1, hashedPackets, unhashedPackets, rand, hashAlgorithm)
		{
		}
