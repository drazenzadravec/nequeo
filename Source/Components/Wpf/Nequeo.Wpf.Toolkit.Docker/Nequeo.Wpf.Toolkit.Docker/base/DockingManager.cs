...
using Nequeo.Wpf.Docker.Controls;
using System.Windows.Input;
using System.Collections;
using System.Collections.Specialized;
using System.Windows.Data;
using System.Windows.Threading;
using Nequeo.Wpf.Docker.Commands;
using Nequeo.Wpf.Docker.Themes;

namespace Nequeo.Wpf.Docker
{
    ...
    public class DockingManager : Control, IOverlayWindowHost//, ILogicalChildrenContainer
    {
        ...
        /// indicates the strategy class to call when Docker needs to positionate a LayoutAnchorable inside an existing layout.
        /// </summary>
        ...
        /// indicates the theme to use for Docker controls.
        /// </summary>
        public Theme Theme
        {
