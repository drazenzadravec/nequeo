...
using Nequeo.Wpf.Docker.Themes;
...
namespace Nequeo.Wpf.Docker.Controls
{
    public abstract class LayoutFloatingWindowControl : Window, ILayoutControl
    {
      private ResourceDictionary currentThemeResourceDictionary; // = null
        ...
        {
            CommandBindings.Add(new CommandBinding(Nequeo.Wpf.Docker.SystemCommands.CloseWindowCommand,
                new ExecutedRoutedEventHandler((s, args) => Nequeo.Wpf.Docker.SystemCommands.CloseWindow((Window)args.Parameter))));
            CommandBindings.Add(new CommandBinding(Nequeo.Wpf.Docker.SystemCommands.MaximizeWindowCommand,
                new ExecutedRoutedEventHandler((s, args) => Nequeo.Wpf.Docker.SystemCommands.MaximizeWindow((Window)args.Parameter))));
            CommandBindings.Add(new CommandBinding(Nequeo.Wpf.Docker.SystemCommands.MinimizeWindowCommand,
                new ExecutedRoutedEventHandler((s, args) => Nequeo.Wpf.Docker.SystemCommands.MinimizeWindow((Window)args.Parameter))));
            CommandBindings.Add(new CommandBinding(Nequeo.Wpf.Docker.SystemCommands.RestoreWindowCommand,
                new ExecutedRoutedEventHandler((s, args) => Nequeo.Wpf.Docker.SystemCommands.RestoreWindow((Window)args.Parameter))));
