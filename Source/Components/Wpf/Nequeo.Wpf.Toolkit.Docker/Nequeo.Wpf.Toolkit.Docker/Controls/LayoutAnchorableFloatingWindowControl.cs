...
using Nequeo.Wpf.Docker.Converters;
...
namespace Nequeo.Wpf.Docker.Controls
{
    public class LayoutAnchorableFloatingWindowControl : LayoutFloatingWindowControl, IOverlayWindowHost
    {
        ...
        internal override void UpdateThemeResources( Nequeo.Wpf.Docker.Themes.Theme oldTheme = null )
        {
        ...
        protected override void OnInitialized(EventArgs e)
        {
            ...
            //Issue: http://Docker.codeplex.com/workitem/15036
