...
namespace Nequeo.Wpf.DataGrid
{
  public abstract partial class DataGridCollectionViewBase : CollectionView, IEditableCollectionView, IWeakEventListener, IItemProperties
  {
    ...
    private void EditItemInternal( object item, out bool beginEditCalled )
    {
      ...
      {
        // editableObject can be an Nequeo DataRow when the datarow is directly inserted in us.
    ...
    private void EndEditInternal( object item, out bool endEditCalled )
    {
      ...
      // editableObject can be an Nequeo datarow when directly inserted as Items in the DataGridControl.
      if( ( editableObject != null ) && ( !( editableObject is Nequeo.Wpf.DataGrid.DataRow ) ) )
      {
    ...
    private void InitializeFromExternalDeclaration( IEnumerable collection, Type itemType )
    {
      ...
      m_autoFilterValues = m_parentDetailDescription.AutoFilterValues as Nequeo.Wpf.Collections.ReadOnlyDictionary<string, IList>;
    ...
    private Nequeo.Wpf.Collections.ReadOnlyDictionary<string, IList> m_autoFilterValues;
