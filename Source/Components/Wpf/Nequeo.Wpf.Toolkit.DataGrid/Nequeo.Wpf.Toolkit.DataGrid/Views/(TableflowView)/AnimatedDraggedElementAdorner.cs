...
namespace Nequeo.Wpf.DataGrid.Views
{
  internal class AnimatedDraggedElementAdorner : DraggedElementAdorner
  {
    ...
    protected override Rectangle InitializeAdornedElementImage()
    {
      ...
      int roundedHeight = ( int )System.Math.Round( adornedBounds.Height, MidpointRounding.ToEven );
      int roundedWidth = ( int )System.Math.Round( adornedBounds.Width, MidpointRounding.ToEven );
