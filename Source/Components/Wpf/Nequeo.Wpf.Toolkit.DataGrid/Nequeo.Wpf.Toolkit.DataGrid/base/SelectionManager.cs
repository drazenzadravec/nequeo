  ...
  internal class SelectionManager
  {
      ...
      bool unselect )
    {
      ...
      if( starting_index != -1 && ending_index != -1 )
      {
        ...
        int min = System.Math.Min( starting_index, ending_index );
        int max = System.Math.Max( starting_index, ending_index );
        ...
        else
        {
          ...
          if( fromRowSelector )
          {
            ...
            fullColumnRange = new SelectionRange( 0, System.Math.Max( 0, newPosition.DataGridContext.ColumnsByVisiblePosition.Count - 1 ) );
          }
          else
          {
    ...
    private void AffectSelectionRange( List<SelectionRangePoint> startPath, List<SelectionRangePoint> endPath, bool unselect )
    {
      ...
      for( int i = System.Math.Max( startPath.Count, endPath.Count ) - 1; i >= 0;i--)
      {
      ...
      bool unselect )
    {
      ...
      {
        int firstIndex = System.Math.Min( startIndex, endIndex );
        int lastIndex = System.Math.Max( startIndex, endIndex );
    ...
    private SelectionCellRangeWithItems GetItemCellRange( DataGridContext dataGridContext, int itemIndex, object item )
    {
      ...
      SelectionRange cellRange = new SelectionRange( 0,
        System.Math.Max( 0, dataGridContext.Columns.Count - 1 ) );
