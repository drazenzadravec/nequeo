...
using Nequeo.Wpf.DataGrid.Utils;
  ...
  public sealed class DataGridContext : DependencyObject, INotifyPropertyChanged, IWeakEventListener, IDataGridContextVisitable, ICustomTypeDescriptor
  {
    ...
    public ObservableCollection<DataTemplate> Footers
    {
      get
      {
        ...
        Nequeo.Wpf.DataGrid.Views.ViewBase view = m_dataGridControl.GetView( false );
        if( view == null )
    ...
    internal CollectionViewGroup GetParentGroupFromItemCore( object item, bool recurseDetails )
    {
      ...
      {
        Nequeo.Wpf.DataGrid.Views.ViewBase view = m_dataGridControl.GetView();
...
#pragma warning restore 618
      ...
      IValueConverter converter = new Nequeo.Wpf.DataGrid.Converters.SourceDataConverter( ItemsSourceHelper.IsItemSupportingDBNull( dataItem ), CultureInfo.InvariantCulture );
        ...
        if( this.Items.Count > 0 )
        {
          ...
          foreach( ColumnBase visibleColumn in this.VisibleColumns )
          {
            if( this.ItemsSourceFieldDescriptors.TryGetValue( visibleColumn.FieldName, out fieldDescriptor ) )
            {
              ...
              {
                Nequeo.Wpf.DataGrid.Converters.ImageConverter converter = new Nequeo.Wpf.DataGrid.Converters.ImageConverter();
    ...
    PropertyDescriptorCollection ICustomTypeDescriptor.GetProperties( Attribute[] attributes )
    {
      if( attributes == null )
      {
        ...
        if( m_viewPropertiesDescriptors == null )
        {
          Nequeo.Wpf.DataGrid.Views.ViewBase view = this.DataGridControl.GetView();
    ...
    internal void RaiseIsSelectedChangedAutomationEvent( DependencyObject container, bool isSelected )
    {
      ...
      if( ( peer != null ) && ( peer.ItemPeers != null ) )
      {
        ...
        if( item != null )
        {
          Nequeo.Wpf.DataGrid.Automation.DataGridItemAutomationPeer itemPeer = peer.ItemPeers[ item ] as Nequeo.Wpf.DataGrid.Automation.DataGridItemAutomationPeer;
    ...
    {
      public ViewBindingPropertyDescriptor( DetailConfiguration detailConfig, DefaultDetailConfiguration defaultDetailConfig, Nequeo.Wpf.DataGrid.Views.ViewBase view, DependencyProperty dp, ViewPropertyMode viewPropertyMode )
        : base( dp.Name, null )
      {
        if( dp == null )
      ...
      public Nequeo.Wpf.DataGrid.Views.ViewBase View
      {
        get
        {
          return m_view;
      ...
      private Nequeo.Wpf.DataGrid.Views.ViewBase m_view;
