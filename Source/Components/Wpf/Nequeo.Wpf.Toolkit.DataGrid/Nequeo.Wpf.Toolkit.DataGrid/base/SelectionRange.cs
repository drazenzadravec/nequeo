  ...
  public struct SelectionRange : IComparable<SelectionRange>
  {
    ...
    public int Length
    {
      get
      {
        ...
        return System.Math.Abs( m_endIndex - m_startIndex ) + 1;
      }
    }
    ...
    public SelectionRange Intersect( SelectionRange range )
    {
      ...
      if( m_startIndex > m_endIndex )
      {
        ...
        newStart = System.Math.Min( range.m_startIndex, m_startIndex );
        newEnd = System.Math.Max( range.m_endIndex, m_endIndex );
      ...
      else
      {
        ...
        newStart = System.Math.Max( range.m_startIndex, m_startIndex );
        newEnd = System.Math.Min( range.m_endIndex, m_endIndex );
