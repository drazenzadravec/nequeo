...
using Nequeo.Wpf.Toolkit.PropertyGrid.Attributes;
using Nequeo.Wpf.Toolkit.PropertyGrid.Editors;
...
using Nequeo.Wpf.Toolkit.PropertyGrid.Converters;
using Nequeo.Wpf.Toolkit.Primitives;
using System.IO;

namespace Nequeo.Wpf.Toolkit.PropertyGrid
{
      ...
      else
      {
        ...
        if( listType != null )
        {
          if( !listType.IsPrimitive && !listType.Equals( typeof( String ) ) && !listType.IsEnum )
            editor = new Nequeo.Wpf.Toolkit.PropertyGrid.Editors.CollectionEditor();
          else
            editor = new Nequeo.Wpf.Toolkit.PropertyGrid.Editors.PrimitiveTypeCollectionEditor();
        }
        else
        {
