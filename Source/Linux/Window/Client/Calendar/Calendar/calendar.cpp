...
wxBEGIN_EVENT_TABLE(MyFrame, wxFrame)
	...
	EVT_UPDATE_UI(Calendar_DatePicker_StartWithNone, MyFrame::OnUpdateUIStartWithNone)
...
bool MyApp::OnInit()
{
	...
	MyFrame *frame = new MyFrame(wxT("Nequeo Calendar")
	...
	: wxFrame((wxFrame *)NULL, wxID_ANY, title, pos, size)
{
	...
	menuCal->AppendCheckItem(Calendar_Cal_Generic, "Use &generic version\tCtrl-G", "Toggle between native and generic control");
