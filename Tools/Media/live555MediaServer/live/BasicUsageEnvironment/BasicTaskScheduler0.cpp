...
BasicTaskScheduler0::BasicTaskScheduler0()
  : _stopEventLoop(false), fLastHandledSocketNum(-1), fTriggersAwaitingHandling(0), fLastUsedTriggerMask(1), fLastUsedTriggerNum(MAX_NUM_EVENT_TRIGGERS-1) {
...
void BasicTaskScheduler0::stopEventLoop(bool stop)
{
	_stopEventLoop = stop;
}
