...
public class ToneGenerator : AudioMedia {
  ...
  public void play(SWIGTYPE_p_std__vectorT_pj__ToneDesc_t tones, bool loop) {
    pjsua2PINVOKE.ToneGenerator_play__SWIG_0(swigCPtr, SWIGTYPE_p_std__vectorT_pj__ToneDesc_t.getCPtr(tones), loop);
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }

  public void play(SWIGTYPE_p_std__vectorT_pj__ToneDesc_t tones) {
    pjsua2PINVOKE.ToneGenerator_play__SWIG_1(swigCPtr, SWIGTYPE_p_std__vectorT_pj__ToneDesc_t.getCPtr(tones));
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }

  public void playDigits(SWIGTYPE_p_std__vectorT_pj__ToneDigit_t digits, bool loop) {
    pjsua2PINVOKE.ToneGenerator_playDigits__SWIG_0(swigCPtr, SWIGTYPE_p_std__vectorT_pj__ToneDigit_t.getCPtr(digits), loop);
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }
