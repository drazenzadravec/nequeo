...
public class OnCallMediaTransportStateParam : global::System.IDisposable {
  ...
  public SWIGTYPE_p_pjsua_med_tp_st state {
    set {
      pjsua2PINVOKE.OnCallMediaTransportStateParam_state_set(swigCPtr, SWIGTYPE_p_pjsua_med_tp_st.getCPtr(value));
      if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      SWIGTYPE_p_pjsua_med_tp_st ret = new SWIGTYPE_p_pjsua_med_tp_st(pjsua2PINVOKE.OnCallMediaTransportStateParam_state_get(swigCPtr), true);
      if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
  ...
  public SWIGTYPE_p_pj_status_t status {
    set {
      pjsua2PINVOKE.OnCallMediaTransportStateParam_status_set(swigCPtr, SWIGTYPE_p_pj_status_t.getCPtr(value));
      if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
    } 
    get {
      SWIGTYPE_p_pj_status_t ret = new SWIGTYPE_p_pj_status_t(pjsua2PINVOKE.OnCallMediaTransportStateParam_status_get(swigCPtr), true);
      if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } 
  }
