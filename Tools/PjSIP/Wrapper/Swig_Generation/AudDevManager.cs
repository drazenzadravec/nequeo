...
public class AudDevManager : global::System.IDisposable {
  ...
  public SWIGTYPE_p_std__vectorT_pj__AudioDevInfo_p_t enumDev() {
    SWIGTYPE_p_std__vectorT_pj__AudioDevInfo_p_t ret = new SWIGTYPE_p_std__vectorT_pj__AudioDevInfo_p_t(pjsua2PINVOKE.AudDevManager_enumDev(swigCPtr), false);
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public int lookupDev(SWIGTYPE_p_string drv_name, SWIGTYPE_p_string dev_name) {
    int ret = pjsua2PINVOKE.AudDevManager_lookupDev(swigCPtr, SWIGTYPE_p_string.getCPtr(drv_name), SWIGTYPE_p_string.getCPtr(dev_name));
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public SWIGTYPE_p_string capName(SWIGTYPE_p_pjmedia_aud_dev_cap cap) {
    SWIGTYPE_p_string ret = new SWIGTYPE_p_string(pjsua2PINVOKE.AudDevManager_capName(swigCPtr, SWIGTYPE_p_pjmedia_aud_dev_cap.getCPtr(cap)), true);
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void setInputRoute(SWIGTYPE_p_pjmedia_aud_dev_route route, bool keep) {
    pjsua2PINVOKE.AudDevManager_setInputRoute__SWIG_0(swigCPtr, SWIGTYPE_p_pjmedia_aud_dev_route.getCPtr(route), keep);
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }

  public void setInputRoute(SWIGTYPE_p_pjmedia_aud_dev_route route) {
    pjsua2PINVOKE.AudDevManager_setInputRoute__SWIG_1(swigCPtr, SWIGTYPE_p_pjmedia_aud_dev_route.getCPtr(route));
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }

  public SWIGTYPE_p_pjmedia_aud_dev_route getInputRoute() {
    SWIGTYPE_p_pjmedia_aud_dev_route ret = new SWIGTYPE_p_pjmedia_aud_dev_route(pjsua2PINVOKE.AudDevManager_getInputRoute(swigCPtr), true);
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void setOutputRoute(SWIGTYPE_p_pjmedia_aud_dev_route route, bool keep) {
    pjsua2PINVOKE.AudDevManager_setOutputRoute__SWIG_0(swigCPtr, SWIGTYPE_p_pjmedia_aud_dev_route.getCPtr(route), keep);
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }

  public void setOutputRoute(SWIGTYPE_p_pjmedia_aud_dev_route route) {
    pjsua2PINVOKE.AudDevManager_setOutputRoute__SWIG_1(swigCPtr, SWIGTYPE_p_pjmedia_aud_dev_route.getCPtr(route));
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }

  public SWIGTYPE_p_pjmedia_aud_dev_route getOutputRoute() {
    SWIGTYPE_p_pjmedia_aud_dev_route ret = new SWIGTYPE_p_pjmedia_aud_dev_route(pjsua2PINVOKE.AudDevManager_getOutputRoute(swigCPtr), true);
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
