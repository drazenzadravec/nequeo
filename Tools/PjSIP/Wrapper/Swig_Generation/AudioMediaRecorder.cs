...
public class AudioMediaRecorder : AudioMedia {
  ...
  public void createRecorder(SWIGTYPE_p_string file_name, uint enc_type, SWIGTYPE_p_pj_ssize_t max_size) {
    pjsua2PINVOKE.AudioMediaRecorder_createRecorder__SWIG_1(swigCPtr, SWIGTYPE_p_string.getCPtr(file_name), enc_type, SWIGTYPE_p_pj_ssize_t.getCPtr(max_size));
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void createRecorder(SWIGTYPE_p_string file_name) {
    pjsua2PINVOKE.AudioMediaRecorder_createRecorder__SWIG_3(swigCPtr, SWIGTYPE_p_string.getCPtr(file_name));
    if (pjsua2PINVOKE.SWIGPendingException.Pending) throw pjsua2PINVOKE.SWIGPendingException.Retrieve();
  }
