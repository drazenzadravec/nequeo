...
using Nequeo.Cryptography.Key.Asn1.X500;
using Nequeo.Cryptography.Key.Math;

namespace Nequeo.Cryptography.Key.Asn1.X509.SigI
{
	/**
	...
	* </pre>
	*
	* @see Nequeo.Cryptography.Key.asn1.x509.sigi.NameOrPseudonym
	* @see Nequeo.Cryptography.Key.asn1.x509.sigi.SigIObjectIdentifiers
	*/
