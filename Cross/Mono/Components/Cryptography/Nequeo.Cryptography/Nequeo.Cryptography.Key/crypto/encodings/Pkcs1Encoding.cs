...
namespace Nequeo.Cryptography.Key.Crypto.Encodings
{
	/**
	...
	*/
		...
		: IAsymmetricBlockCipher
	{
		 ...
		 * work with one of these set the system property Nequeo.Cryptography.Key.Pkcs1.Strict to false.
		 */
		public const string StrictLengthEnabledProperty = "Nequeo.Cryptography.Key.Pkcs1.Strict";
